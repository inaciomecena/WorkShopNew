spec_i([ trn,5,'Product','Product_BC',[],por,'17_0_9-159740' ]).
 
struct_i(6,0,[ 'Websession' ],[]).
...
las_i(6,[ [ 'Websession',12,13,26,27,28,40000,14,39,6,7,10,18,19,40001,8,9 ] ]).
...
rule_i(0,prop(idISBUSINESSCOMPONENT,'-1')).
...
rule_i(6,rule([ a(19,[ [ 6 ],msg([ t('"Não existe ''Category''."',3) ],[ t('ForeignKeyNotFound',3) ]) ]) ],[],[ insert,update,delete ],[ 6 ])).
rule_i(6,rule([ a(19,[ [ 10 ],msg([ t('"Não existe ''Seller''."',3) ],[ t('ForeignKeyNotFound',3) ]) ]) ],[],[ insert,update,delete ],[ 10 ])).
rule_i(6,rule([ a(19,[ [ 14 ],msg([ t('"Não existe ''Country Product''."',3) ],[ t('ForeignKeyNotFound',3) ]) ]) ],[],[ insert,update,delete ],[ 14 ])).
rule_i(6,rule([ a(19,[ [ 8 ],msg([ t('"Não existe ''Country''."',3) ],[ t('ForeignKeyNotFound',3) ]) ]) ],[],[ insert,update,delete ],[ 8 ])).
 
a_i(1,6,b,1,[],[ [],[ a(1,[ t('"Their name cannot be empty"',3) ]) ],[ t('null(',1),t(13,2),t(')',4) ] ]).
a_i(2,6,b,2,[],[ [],[ a(1,[ t('"Their price cannot be empty"',3) ]) ],[ t('null(',1),t(27,2),t(')',4) ] ]).
a_i(3,6,t,6,[],[ [ [ [],12,12 ] ],'IPRODUCT',[] ]).
a_i(4,6,k,6,[],[ [ [ [],13,13 ] ],'UPRODUCT',[] ]).
a_i(5,6,r,2,[],[ [ [ 6,6,6 ] ],'ICATEGORY',[] ]).
a_i(6,6,r,4,[],[ [ [ 6,10,10 ] ],'ISELLER',[] ]).
a_i(7,6,r,502,[],[ [ [ 6,14,8 ] ],'ICOUNTRY',[] ]).
a_i(8,6,r,3,[],[ [ [ 4,8,8 ] ],'ICOUNTRY',[] ]).
...
b_line_i(36,2,2,cmd,1,[ t('',147,36,0) ]).
b_line_i(38,2,2,cmd,1,[ t('',146,38,0),t('After Trn',3,38,7) ]).
b_line_i(49,2,3,cmd,1,[ t('',147,49,0) ]).
...
i_tbl_best_trn(6,[ 5,1,'Product','Product',[ 39 ] ]).
i_tbl_best_trn(10,[ 6,2,'ShoppingCart','Shopping Cart',[] ]).
i_tbl_best_trn(2,[ 2,1,'Category','Category',[] ]).
i_tbl_best_trn(502,[ 3,1,'Country','Country',[] ]).
i_tbl_best_trn(3,[ 3,1,'Country','Country',[] ]).
...
struct_dt_i([ 0,5,0 ],namespace,'WorkShopNew').
...
struct_dt_i([ 0,5,0 ],'ExternalNamespace','WorkShopNew').
struct_dt_i([ 0,5,0 ],key,[ 12 ]).
struct_dt_i([ 0,5,0 ],lvl,6).
...
struct_dt_elem_i([ 0,5,0 ],1,basedon,88).
struct_dt_elem_i([ 0,5,0 ],1,length,4).
struct_dt_elem_i([ 0,5,0 ],1,decimals,0).
struct_dt_elem_i([ 0,5,0 ],1,sign,0).
struct_dt_elem_i([ 0,5,0 ],1,type,[ 4,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],1,pic,'ZZZ9').
struct_dt_elem_i([ 0,5,0 ],1,collection,'False').
struct_dt_elem_i([ 0,5,0 ],1,attributeid,'12').
struct_dt_elem_i([ 0,5,0 ],1,'ExternalName','ProductId').
struct_dt_elem_i([ 0,5,0 ],1,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],2,name,'Productname').
struct_dt_elem_i([ 0,5,0 ],2,camelname,'ProductName').
struct_dt_elem_i([ 0,5,0 ],2,basedon,89).
struct_dt_elem_i([ 0,5,0 ],2,length,20).
struct_dt_elem_i([ 0,5,0 ],2,decimals,0).
struct_dt_elem_i([ 0,5,0 ],2,type,[ 5,20,0 ]).
struct_dt_elem_i([ 0,5,0 ],2,pic,'').
struct_dt_elem_i([ 0,5,0 ],2,collection,'False').
struct_dt_elem_i([ 0,5,0 ],2,attributeid,'13').
struct_dt_elem_i([ 0,5,0 ],2,'ExternalName','ProductName').
struct_dt_elem_i([ 0,5,0 ],2,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],3,name,'Productdescription').
struct_dt_elem_i([ 0,5,0 ],3,camelname,'ProductDescription').
struct_dt_elem_i([ 0,5,0 ],3,length,50).
struct_dt_elem_i([ 0,5,0 ],3,decimals,0).
struct_dt_elem_i([ 0,5,0 ],3,type,[ 5,50,0 ]).
struct_dt_elem_i([ 0,5,0 ],3,pic,'').
struct_dt_elem_i([ 0,5,0 ],3,collection,'False').
struct_dt_elem_i([ 0,5,0 ],3,attributeid,'26').
struct_dt_elem_i([ 0,5,0 ],3,'ExternalName','ProductDescription').
struct_dt_elem_i([ 0,5,0 ],3,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],4,name,'Productprice').
struct_dt_elem_i([ 0,5,0 ],4,camelname,'ProductPrice').
struct_dt_elem_i([ 0,5,0 ],4,length,8).
struct_dt_elem_i([ 0,5,0 ],4,decimals,2).
struct_dt_elem_i([ 0,5,0 ],4,sign,0).
struct_dt_elem_i([ 0,5,0 ],4,type,[ 4,8,2 ]).
struct_dt_elem_i([ 0,5,0 ],4,pic,'$ ZZZZ9.99').
struct_dt_elem_i([ 0,5,0 ],4,collection,'False').
struct_dt_elem_i([ 0,5,0 ],4,attributeid,'27').
struct_dt_elem_i([ 0,5,0 ],4,'ExternalName','ProductPrice').
struct_dt_elem_i([ 0,5,0 ],4,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],5,name,'Productphoto').
struct_dt_elem_i([ 0,5,0 ],5,camelname,'ProductPhoto').
struct_dt_elem_i([ 0,5,0 ],5,length,4).
struct_dt_elem_i([ 0,5,0 ],5,decimals,0).
struct_dt_elem_i([ 0,5,0 ],5,type,[ 7,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],5,pic,'').
struct_dt_elem_i([ 0,5,0 ],5,collection,'False').
struct_dt_elem_i([ 0,5,0 ],5,attributeid,'28').
struct_dt_elem_i([ 0,5,0 ],5,'ExternalName','ProductPhoto').
struct_dt_elem_i([ 0,5,0 ],5,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],6,name,'Productphoto_gxi').
struct_dt_elem_i([ 0,5,0 ],6,camelname,'ProductPhoto_GXI').
struct_dt_elem_i([ 0,5,0 ],6,collection,'False').
struct_dt_elem_i([ 0,5,0 ],6,isadd,'True').
struct_dt_elem_i([ 0,5,0 ],6,length,2048).
struct_dt_elem_i([ 0,5,0 ],6,decimals,0).
struct_dt_elem_i([ 0,5,0 ],6,type,[ 13,2048,0 ]).
struct_dt_elem_i([ 0,5,0 ],7,name,'Productcountryid').
struct_dt_elem_i([ 0,5,0 ],7,camelname,'ProductCountryID').
struct_dt_elem_i([ 0,5,0 ],7,basedon,88).
struct_dt_elem_i([ 0,5,0 ],7,length,4).
struct_dt_elem_i([ 0,5,0 ],7,decimals,0).
struct_dt_elem_i([ 0,5,0 ],7,sign,0).
struct_dt_elem_i([ 0,5,0 ],7,type,[ 4,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],7,pic,'ZZZ9').
struct_dt_elem_i([ 0,5,0 ],7,collection,'False').
struct_dt_elem_i([ 0,5,0 ],7,attributeid,'14').
struct_dt_elem_i([ 0,5,0 ],7,'ExternalName','ProductCountryID').
struct_dt_elem_i([ 0,5,0 ],7,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],8,name,'Productcountryname').
struct_dt_elem_i([ 0,5,0 ],8,camelname,'ProductCountryName').
struct_dt_elem_i([ 0,5,0 ],8,basedon,89).
struct_dt_elem_i([ 0,5,0 ],8,length,20).
struct_dt_elem_i([ 0,5,0 ],8,decimals,0).
struct_dt_elem_i([ 0,5,0 ],8,type,[ 5,20,0 ]).
struct_dt_elem_i([ 0,5,0 ],8,pic,'').
struct_dt_elem_i([ 0,5,0 ],8,collection,'False').
struct_dt_elem_i([ 0,5,0 ],8,attributeid,'39').
struct_dt_elem_i([ 0,5,0 ],8,'ExternalName','ProductCountryName').
struct_dt_elem_i([ 0,5,0 ],8,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],9,name,'Categoryid').
struct_dt_elem_i([ 0,5,0 ],9,camelname,'CategoryId').
struct_dt_elem_i([ 0,5,0 ],9,basedon,88).
struct_dt_elem_i([ 0,5,0 ],9,length,4).
struct_dt_elem_i([ 0,5,0 ],9,decimals,0).
struct_dt_elem_i([ 0,5,0 ],9,sign,0).
struct_dt_elem_i([ 0,5,0 ],9,type,[ 4,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],9,pic,'ZZZ9').
struct_dt_elem_i([ 0,5,0 ],9,collection,'False').
struct_dt_elem_i([ 0,5,0 ],9,attributeid,'6').
struct_dt_elem_i([ 0,5,0 ],9,'ExternalName','CategoryId').
struct_dt_elem_i([ 0,5,0 ],9,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],10,name,'Categoryname').
struct_dt_elem_i([ 0,5,0 ],10,camelname,'CategoryName').
struct_dt_elem_i([ 0,5,0 ],10,basedon,89).
struct_dt_elem_i([ 0,5,0 ],10,length,20).
struct_dt_elem_i([ 0,5,0 ],10,decimals,0).
struct_dt_elem_i([ 0,5,0 ],10,type,[ 5,20,0 ]).
struct_dt_elem_i([ 0,5,0 ],10,pic,'').
struct_dt_elem_i([ 0,5,0 ],10,collection,'False').
struct_dt_elem_i([ 0,5,0 ],10,attributeid,'7').
struct_dt_elem_i([ 0,5,0 ],10,'ExternalName','CategoryName').
struct_dt_elem_i([ 0,5,0 ],10,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],11,name,'Sellerid').
struct_dt_elem_i([ 0,5,0 ],11,camelname,'SellerId').
struct_dt_elem_i([ 0,5,0 ],11,basedon,88).
struct_dt_elem_i([ 0,5,0 ],11,length,4).
struct_dt_elem_i([ 0,5,0 ],11,decimals,0).
struct_dt_elem_i([ 0,5,0 ],11,sign,0).
struct_dt_elem_i([ 0,5,0 ],11,type,[ 4,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],11,pic,'ZZZ9').
struct_dt_elem_i([ 0,5,0 ],11,collection,'False').
struct_dt_elem_i([ 0,5,0 ],11,attributeid,'10').
struct_dt_elem_i([ 0,5,0 ],11,'ExternalName','SellerId').
struct_dt_elem_i([ 0,5,0 ],11,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],12,name,'Sellername').
struct_dt_elem_i([ 0,5,0 ],12,camelname,'SellerName').
struct_dt_elem_i([ 0,5,0 ],12,basedon,89).
struct_dt_elem_i([ 0,5,0 ],12,length,20).
struct_dt_elem_i([ 0,5,0 ],12,decimals,0).
struct_dt_elem_i([ 0,5,0 ],12,type,[ 5,20,0 ]).
struct_dt_elem_i([ 0,5,0 ],12,pic,'').
struct_dt_elem_i([ 0,5,0 ],12,collection,'False').
struct_dt_elem_i([ 0,5,0 ],12,attributeid,'18').
struct_dt_elem_i([ 0,5,0 ],12,'ExternalName','SellerName').
struct_dt_elem_i([ 0,5,0 ],12,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],13,name,'Sellerphoto').
struct_dt_elem_i([ 0,5,0 ],13,camelname,'SellerPhoto').
struct_dt_elem_i([ 0,5,0 ],13,length,4).
struct_dt_elem_i([ 0,5,0 ],13,decimals,0).
struct_dt_elem_i([ 0,5,0 ],13,type,[ 7,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],13,pic,'').
struct_dt_elem_i([ 0,5,0 ],13,collection,'False').
struct_dt_elem_i([ 0,5,0 ],13,attributeid,'19').
struct_dt_elem_i([ 0,5,0 ],13,'ExternalName','SellerPhoto').
struct_dt_elem_i([ 0,5,0 ],13,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],14,name,'Sellerphoto_gxi').
struct_dt_elem_i([ 0,5,0 ],14,camelname,'SellerPhoto_GXI').
struct_dt_elem_i([ 0,5,0 ],14,collection,'False').
struct_dt_elem_i([ 0,5,0 ],14,isadd,'True').
struct_dt_elem_i([ 0,5,0 ],14,length,2048).
struct_dt_elem_i([ 0,5,0 ],14,decimals,0).
struct_dt_elem_i([ 0,5,0 ],14,type,[ 13,2048,0 ]).
struct_dt_elem_i([ 0,5,0 ],15,name,'Countryid').
struct_dt_elem_i([ 0,5,0 ],15,camelname,'CountryId').
struct_dt_elem_i([ 0,5,0 ],15,basedon,88).
struct_dt_elem_i([ 0,5,0 ],15,length,4).
struct_dt_elem_i([ 0,5,0 ],15,decimals,0).
struct_dt_elem_i([ 0,5,0 ],15,sign,0).
struct_dt_elem_i([ 0,5,0 ],15,type,[ 4,4,0 ]).
struct_dt_elem_i([ 0,5,0 ],15,pic,'ZZZ9').
struct_dt_elem_i([ 0,5,0 ],15,collection,'False').
struct_dt_elem_i([ 0,5,0 ],15,attributeid,'8').
struct_dt_elem_i([ 0,5,0 ],15,'ExternalName','CountryId').
struct_dt_elem_i([ 0,5,0 ],15,'ExternalNamespace','WorkShopNew').
struct_dt_elem_i([ 0,5,0 ],16,name,'Countryname').
struct_dt_elem_i([ 0,5,0 ],16,camelname,'CountryName').
struct_dt_elem_i([ 0,5,0 ],16,basedon,89).
struct_dt_elem_i([ 0,5,0 ],16,length,20).
struct_dt_elem_i([ 0,5,0 ],16,decimals,0).
struct_dt_elem_i([ 0,5,0 ],16,type,[ 5,20,0 ]).
struct_dt_elem_i([ 0,5,0 ],16,pic,'').
struct_dt_elem_i([ 0,5,0 ],16,collection,'False').
struct_dt_elem_i([ 0,5,0 ],16,attributeid,'9').
struct_dt_elem_i([ 0,5,0 ],16,'ExternalName','CountryName').
struct_dt_elem_i([ 0,5,0 ],16,'ExternalNamespace','WorkShopNew').
...
struct_dt_elem_i([ 26,13,30 ],1,'ExternalNamespace','WorkShopNew').
...
struct_dt_elem_i([ 26,13,30 ],2,'ExternalNamespace','WorkShopNew').
...
struct_dt_elem_i([ 26,13,30 ],3,'ExternalNamespace','WorkShopNew').
...
struct_dt_elem_i([ 0,5,0 ],6,attributeid,'40000').
struct_dt_elem_i([ 0,5,0 ],14,attributeid,'40001').
 
 
 
 
 
sub_info_i(146,'Start',1,36,[ [],[] ]).
sub_info_i(146,'After Trn',38,49,[ [],[] ]).
 
 
pgm_callprotocol_i(trn,5,'PRODUCT_BC','INTERNAL','Unsecure').
