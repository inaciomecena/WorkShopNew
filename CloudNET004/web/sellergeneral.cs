...
namespace GeneXus.Programs {
   public class sellergeneral : GXWebComponent
   {
      public sellergeneral( )
      {
      ...
      public sellergeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A10SellerId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Seller General") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202352622252255", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sellergeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A10SellerId,4,0))}, new string[] {"SellerId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"SellerGeneral");
         forbiddenHiddens.Add("CountryId", context.localUtil.Format( (decimal)(A8CountryId), "ZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("sellergeneral:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA10SellerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA10SellerId), 4, 0, ",", "")));
      }
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "sellergeneral.aspx");
            }
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSellerName_Internalname, StringUtil.RTrim( A18SellerName), StringUtil.RTrim( context.localUtil.Format( A18SellerName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtSellerName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_SellerGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgSellerPhoto_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 1, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A19SellerPhoto_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_SellerGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0R2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Seller General", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000SellerPhoto_GXI = H000R2_A40000SellerPhoto_GXI[0];
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), true);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A19SellerPhoto), true);
               A9CountryName = H000R2_A9CountryName[0];
               AssignAttri(sPrefix, false, "A9CountryName", A9CountryName);
               A8CountryId = H000R2_A8CountryId[0];
               AssignAttri(sPrefix, false, "A8CountryId", StringUtil.LTrimStr( (decimal)(A8CountryId), 4, 0));
               A18SellerName = H000R2_A18SellerName[0];
               AssignAttri(sPrefix, false, "A18SellerName", A18SellerName);
               A19SellerPhoto = H000R2_A19SellerPhoto[0];
      ...
      protected void STRUP0R0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA10SellerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA10SellerId"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("sellergeneral:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Transactionname = "Seller";
         AV8TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV8TrnContextAtt.gxTpr_Attributename = "SellerId";
         AV8TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SellerId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A10SellerId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A10SellerId", StringUtil.LTrimStr( (decimal)(A10SellerId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA10SellerId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "sellergeneral", GetJustCreated( ));
         ...
         {
            A10SellerId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A10SellerId", StringUtil.LTrimStr( (decimal)(A10SellerId), 4, 0));
         }
         wcpOA10SellerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA10SellerId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A10SellerId != wcpOA10SellerId ) ) )
         {
            setjustcreated();
         }
         wcpOA10SellerId = A10SellerId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA10SellerId = cgiGet( sPrefix+"A10SellerId_CTRL");
         if ( StringUtil.Len( sCtrlA10SellerId) > 0 )
         {
            A10SellerId = (short)(context.localUtil.CToN( cgiGet( sCtrlA10SellerId), ",", "."));
            AssignAttri(sPrefix, false, "A10SellerId", StringUtil.LTrimStr( (decimal)(A10SellerId), 4, 0));
         }
         else
         {
            A10SellerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A10SellerId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A10SellerId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A10SellerId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA10SellerId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A10SellerId_CTRL", StringUtil.RTrim( sCtrlA10SellerId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235262225237", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sellergeneral.js", "?20235262225238", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A10SellerId',fld:'SELLERID',pic:'ZZZ9'},{av:'A8CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000R2_A10SellerId = new short[1] ;
         H000R2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000R2_A9CountryName = new string[] {""} ;
         H000R2_A8CountryId = new short[1] ;
         H000R2_A18SellerName = new string[] {""} ;
         H000R2_A19SellerPhoto = new string[] {""} ;
         hsh = "";
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         sCtrlA10SellerId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sellergeneral__default(),
            new Object[][] {
                new Object[] {
               H000R2_A10SellerId, H000R2_A40000SellerPhoto_GXI, H000R2_A9CountryName, H000R2_A8CountryId, H000R2_A18SellerName, H000R2_A19SellerPhoto
               }
            }
         );
         AV13Pgmname = "SellerGeneral";
      ...
      private string hsh ;
      private string sCtrlA10SellerId ;
      ...
      private short[] H000R2_A10SellerId ;
      private string[] H000R2_A40000SellerPhoto_GXI ;
      private string[] H000R2_A9CountryName ;
      private short[] H000R2_A8CountryId ;
      private string[] H000R2_A18SellerName ;
      private string[] H000R2_A19SellerPhoto ;
   ...
   public class sellergeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000R2", "SELECT T1.[SellerId], T1.[SellerPhoto_GXI], T2.[CountryName], T1.[CountryId], T1.[SellerName], T1.[SellerPhoto] FROM ([Seller] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) WHERE T1.[SellerId] = @SellerId ORDER BY T1.[SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
