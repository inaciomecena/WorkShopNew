   ...
   public class promotionproductwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6PromotionId = (short)(NumberUtil.Val( GetPar( "PromotionId"), "."));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "PromotionProductWC";
               context.Gx_err = 0;
               WS1O2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202352622252269", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB1O0( )
      {
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPromotionId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15PromotionId), 4, 0, ",", "")), StringUtil.LTrim( ((edtPromotionId_Enabled!=0) ? context.localUtil.Format( (decimal)(A15PromotionId), "ZZZ9") : context.localUtil.Format( (decimal)(A15PromotionId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPromotionId_Jsonclick, 0, "Attribute", "", "", "", "", edtPromotionId_Visible, edtPromotionId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_PromotionProductWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF1O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15PromotionId = H001O2_A15PromotionId[0];
               AssignAttri(sPrefix, false, "A15PromotionId", StringUtil.LTrimStr( (decimal)(A15PromotionId), 4, 0));
               A27ProductPrice = H001O2_A27ProductPrice[0];
               A13ProductName = H001O2_A13ProductName[0];
               A12ProductId = H001O2_A12ProductId[0];
               A27ProductPrice = H001O2_A27ProductPrice[0];
               A13ProductName = H001O2_A13ProductName[0];
               E121O2 ();
      ...
      protected void STRUP1O0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6PromotionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PromotionId"), ",", "."));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6PromotionId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6PromotionId), ",", "."));
            AssignAttri(sPrefix, false, "AV6PromotionId", StringUtil.LTrimStr( (decimal)(AV6PromotionId), 4, 0));
         }
         else
         {
            AV6PromotionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6PromotionId_PARM"), ",", "."));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202352622252343", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("promotionproductwc.js", "?202352622252344", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E121O2',iparms:[{av:'A12ProductId',fld:'PRODUCTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtProductName_Link',ctrl:'PRODUCTNAME',prop:'Link'}]}");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001O2_A15PromotionId = new short[1] ;
         H001O2_A27ProductPrice = new decimal[1] ;
         H001O2_A13ProductName = new string[] {""} ;
         H001O2_A12ProductId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promotionproductwc__default(),
            new Object[][] {
                new Object[] {
               H001O2_A15PromotionId, H001O2_A27ProductPrice, H001O2_A13ProductName, H001O2_A12ProductId
               }
               , new Object[] {
      ...
      private short[] H001O2_A15PromotionId ;
      private decimal[] H001O2_A27ProductPrice ;
      private string[] H001O2_A13ProductName ;
      private short[] H001O2_A12ProductId ;
   ...
   public class promotionproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001O2", "SELECT T1.[PromotionId], T2.[ProductPrice], T2.[ProductName], T1.[ProductId] FROM ([PromotionProduct] T1 INNER JOIN [Product] T2 ON T2.[ProductId] = T1.[ProductId]) WHERE T1.[PromotionId] = @AV6PromotionId ORDER BY T1.[PromotionId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001O2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001O3", "SELECT COUNT(*) FROM ([PromotionProduct] T1 INNER JOIN [Product] T2 ON T2.[ProductId] = T1.[ProductId]) WHERE T1.[PromotionId] = @AV6PromotionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001O3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
