...
namespace GeneXus.Programs {
   public class acategory_dataprovider : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBCCollection<SdtCategory>( context, "Category", "WorkShopNew") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBCCollection<SdtCategory> aP0_Gxm2rootcol )
      {
         ...
         objacategory_dataprovider.Gxm2rootcol = new GXBCCollection<SdtCategory>( context, "Category", "WorkShopNew") ;
