   ...
   public class shoppingcartproductwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6ShoppingCartId = (short)(NumberUtil.Val( GetPar( "ShoppingCartId"), "."));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "ShoppingCartProductWC";
               context.Gx_err = 0;
               WS0P2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202352622252382", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A36QtyProduct), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A35TotalProduct, 11, 2, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtShoppingCartId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A16ShoppingCartId), 4, 0, ",", "")), StringUtil.LTrim( ((edtShoppingCartId_Enabled!=0) ? context.localUtil.Format( (decimal)(A16ShoppingCartId), "ZZZ9") : context.localUtil.Format( (decimal)(A16ShoppingCartId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtShoppingCartId_Jsonclick, 0, "Attribute", "", "", "", "", edtShoppingCartId_Visible, edtShoppingCartId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_ShoppingCartProductWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6ShoppingCartId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ShoppingCartId"), ",", "."));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6ShoppingCartId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6ShoppingCartId), ",", "."));
            AssignAttri(sPrefix, false, "AV6ShoppingCartId", StringUtil.LTrimStr( (decimal)(AV6ShoppingCartId), 4, 0));
         }
         else
         {
            AV6ShoppingCartId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6ShoppingCartId_PARM"), ",", "."));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202352622252484", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("shoppingcartproductwc.js", "?202352622252484", false, true);
         }
      ...
      protected void SubsflControlProps_122( )
      {
         ...
         edtQtyProduct_Internalname = sPrefix+"QTYPRODUCT_"+sGXsfl_12_idx;
         edtTotalProduct_Internalname = sPrefix+"TOTALPRODUCT_"+sGXsfl_12_idx;
      ...
      protected void SubsflControlProps_fel_122( )
      {
         ...
         edtQtyProduct_Internalname = sPrefix+"QTYPRODUCT_"+sGXsfl_12_fel_idx;
         edtTotalProduct_Internalname = sPrefix+"TOTALPRODUCT_"+sGXsfl_12_fel_idx;
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtQtyProduct_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A36QtyProduct), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A36QtyProduct), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtQtyProduct_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTotalProduct_Internalname,StringUtil.LTrim( StringUtil.NToC( A35TotalProduct, 11, 2, ",", "")),StringUtil.LTrim( context.localUtil.Format( A35TotalProduct, "R$ ZZZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTotalProduct_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)11,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtQtyProduct_Internalname = sPrefix+"QTYPRODUCT";
         edtTotalProduct_Internalname = sPrefix+"TOTALPRODUCT";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E120P2',iparms:[{av:'A12ProductId',fld:'PRODUCTID',pic:'ZZZ9'},{av:'A6CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000P2_A16ShoppingCartId = new short[1] ;
         H000P2_A6CategoryId = new short[1] ;
         H000P2_A13ProductName = new string[] {""} ;
         H000P2_A12ProductId = new short[1] ;
         H000P2_A7CategoryName = new string[] {""} ;
         H000P2_A27ProductPrice = new decimal[1] ;
         H000P2_A36QtyProduct = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.shoppingcartproductwc__default(),
            new Object[][] {
                new Object[] {
               H000P2_A16ShoppingCartId, H000P2_A6CategoryId, H000P2_A13ProductName, H000P2_A12ProductId, H000P2_A7CategoryName, H000P2_A27ProductPrice, H000P2_A36QtyProduct
               }
               , new Object[] {
      ...
      private short[] H000P2_A16ShoppingCartId ;
      private short[] H000P2_A6CategoryId ;
      private string[] H000P2_A13ProductName ;
      private short[] H000P2_A12ProductId ;
      private string[] H000P2_A7CategoryName ;
      private decimal[] H000P2_A27ProductPrice ;
      private short[] H000P2_A36QtyProduct ;
   ...
   public class shoppingcartproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000P2", "SELECT T1.[ShoppingCartId], T2.[CategoryId], T2.[ProductName], T1.[ProductId], T3.[CategoryName], T2.[ProductPrice], T1.[QtyProduct] FROM (([ShoppingCartProduct] T1 INNER JOIN [Product] T2 ON T2.[ProductId] = T1.[ProductId]) INNER JOIN [Category] T3 ON T3.[CategoryId] = T2.[CategoryId]) WHERE T1.[ShoppingCartId] = @AV6ShoppingCartId ORDER BY T1.[ShoppingCartId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000P3", "SELECT COUNT(*) FROM (([ShoppingCartProduct] T1 INNER JOIN [Product] T2 ON T2.[ProductId] = T1.[ProductId]) INNER JOIN [Category] T3 ON T3.[CategoryId] = T2.[CategoryId]) WHERE T1.[ShoppingCartId] = @AV6ShoppingCartId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
