...
namespace GeneXus.Programs {
   public class categoriesandproducts : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235211522424", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void initialize_formulas( )
      {
         ...
         context.Gx_err = 0;
         edtavList_Enabled = 0;
         AssignProp("", false, edtavList_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavList_Enabled), 5, 0), !bGXsfl_9_Refreshing);
      }
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A7CategoryName = H000J2_A7CategoryName[0];
               A6CategoryId = H000J2_A6CategoryId[0];
               /* Execute user event: Load */
               E130J2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235211522455", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("categoriesandproducts.js", "?20235211522456", false, true);
         /* End function include_jscripts */
      }

      protected void SubsflControlProps_92( )
      {
         edtCategoryId_Internalname = "CATEGORYID_"+sGXsfl_9_idx;
         edtCategoryName_Internalname = "CATEGORYNAME_"+sGXsfl_9_idx;
         edtavList_Internalname = "vLIST_"+sGXsfl_9_idx;
      }

      protected void SubsflControlProps_fel_92( )
      {
         edtCategoryId_Internalname = "CATEGORYID_"+sGXsfl_9_fel_idx;
         edtCategoryName_Internalname = "CATEGORYNAME_"+sGXsfl_9_fel_idx;
         edtavList_Internalname = "vLIST_"+sGXsfl_9_fel_idx;
      }
      ...
      protected void sendrow_92( )
      {
         ...
         /* Single line edit */
         TempTags = " " + ((edtavList_Enabled!=0)&&(edtavList_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 12,'',false,'"+sGXsfl_9_idx+"',9)\"" : " ");
         ROClassString = "";
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavList_Internalname,StringUtil.RTrim( AV5List),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavList_Enabled!=0)&&(edtavList_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,12);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+"e140j2_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavList_Jsonclick,(short)7,(string)"",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtavList_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)9,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
      ...
      {
         lblCategoriesandproductstitle_Internalname = "CATEGORIESANDPRODUCTSTITLE";
      ...
      public override void initialize( )
      {
         ...
         Form = new GXWebForm();
         sPrefix = "";
         lblCategoriesandproductstitle_Jsonclick = "";
         Grid1Container = new GXWebGrid( context);
         sStyleString = "";
         subGrid1_Linesclass = "";
         ...
         sEvtType = "";
         scmdbuf = "";
         H000J2_A7CategoryName = new string[] {""} ;
         H000J2_A6CategoryId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.categoriesandproducts__default(),
            new Object[][] {
                new Object[] {
               H000J2_A7CategoryName, H000J2_A6CategoryId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string lblCategoriesandproductstitle_Internalname ;
      private string lblCategoriesandproductstitle_Jsonclick ;
      ...
      private string[] H000J2_A7CategoryName ;
      private short[] H000J2_A6CategoryId ;
   ...
   public class categoriesandproducts__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000J2", "SELECT [CategoryName], [CategoryId] FROM [Category] ORDER BY [CategoryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J2,11, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
