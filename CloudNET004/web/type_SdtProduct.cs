...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Product" , Namespace = "WorkShopNew" )]
   [Serializable]
   public class SdtProduct : GxSilentTrnSdt
   {
      ...
      public void Load( short AV12ProductId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV12ProductId});
         return  ;
      }
   ...
   [DataContract(Name = @"Product", Namespace = "WorkShopNew")]
   public class SdtProduct_RESTInterface : GxGenericCollectionItem<SdtProduct>
   {
      ...
      [DataMember( Name = "CategoryName" , Order = 8 )]
      [GxSeudo()]
      public string gxTpr_Categoryname
      {
         get {
      ...
      [DataMember( Name = "SellerId" , Order = 9 )]
      [GxSeudo()]
      ...
      [DataMember( Name = "SellerName" , Order = 10 )]
      [GxSeudo()]
      public string gxTpr_Sellername
      {
         get {
      ...
      [DataMember( Name = "SellerPhoto" , Order = 11 )]
      [GxUpload()]
      public string gxTpr_Sellerphoto
      {
         get {
