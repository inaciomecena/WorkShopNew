...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Category" , Namespace = "WorkShopNew" )]
   [Serializable]
   public class SdtCategory : GxSilentTrnSdt
   {
      public SdtCategory( )
      {
      }
      ...
      public void Load( short AV6CategoryId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV6CategoryId});
         return  ;
      }
   ...
   [DataContract(Name = @"Category", Namespace = "WorkShopNew")]
   public class SdtCategory_RESTInterface : GxGenericCollectionItem<SdtCategory>
   {
   ...
   [DataContract(Name = @"Category", Namespace = "WorkShopNew")]
   public class SdtCategory_RESTLInterface : GxGenericCollectionItem<SdtCategory>
   {
