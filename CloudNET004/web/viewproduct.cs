...
namespace GeneXus.Programs {
   public class viewproduct : GXDataArea
   {
      public viewproduct( )
      {
      ...
      public viewproduct( IGxContext context )
      {
      ...
      public void execute( short aP0_ProductId ,
                           string aP1_TabCode )
      {
         this.AV12ProductId = aP0_ProductId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ProductId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12ProductId", StringUtil.LTrimStr( (decimal)(AV12ProductId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202352622254676", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewproduct.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewProduct");
         forbiddenHiddens.Add("ProductName", StringUtil.RTrim( context.localUtil.Format( A13ProductName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewproduct:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRODUCTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ProductId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductId), "ZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Product1wc == null ) )
         {
            WebComp_Product1wc.componentjscripts();
         }
      }
      ...
      {
         return formatLink("viewproduct.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductId","TabCode"})  ;
      }
      ...
      protected void WB1G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Produtos Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewProduct.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Produtoss", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewProduct.htm");
            ...
            GxWebStd.gx_label_element( context, edtProductName_Internalname, "Nome", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductName_Internalname, StringUtil.RTrim( A13ProductName), StringUtil.RTrim( context.localUtil.Format( A13ProductName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtProductName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewProduct.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProduct.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Promoção", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProduct.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableproduct_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Productwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct1_title_Internalname, "Carrinho de Compras", "", "", lblProduct1_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProduct.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Product1") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABContainer"+"panel3"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableproduct1_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0046"+"", StringUtil.RTrim( WebComp_Product1wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0046"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldProduct1wc), StringUtil.Lower( WebComp_Product1wc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0046"+"");
                  }
                  WebComp_Product1wc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldProduct1wc), StringUtil.Lower( WebComp_Product1wc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START1G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Product", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 38 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
                           {
                              WebComp_Productwc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Productwc_Component = OldProductwc;
                        }
                        else if ( nCmpId == 46 )
                        {
                           OldProduct1wc = cgiGet( "W0046");
                           if ( ( StringUtil.Len( OldProduct1wc) == 0 ) || ( StringUtil.StrCmp(OldProduct1wc, WebComp_Product1wc_Component) != 0 ) )
                           {
                              WebComp_Product1wc = getWebComponent(GetType(), "GeneXus.Programs", OldProduct1wc, new Object[] {context} );
                              WebComp_Product1wc.ComponentInit();
                              WebComp_Product1wc.Name = "OldProduct1wc";
                              WebComp_Product1wc_Component = OldProduct1wc;
                           }
                           if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
                           {
                              WebComp_Product1wc.componentprocess("W0046", "", sEvt);
                           }
                           WebComp_Product1wc_Component = OldProduct1wc;
                        }
                     }
      ...
      protected void RF1G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
               {
                  WebComp_Product1wc.componentstart();
               }
            }
         }
         ...
         {
            /* Using cursor H001G2 */
            pr_default.execute(0, new Object[] {AV12ProductId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A12ProductId = H001G2_A12ProductId[0];
               A13ProductName = H001G2_A13ProductName[0];
      ...
      protected void STRUP1G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductId = (short)(context.localUtil.CToN( cgiGet( "vPRODUCTID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewproduct:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E111G2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H001G3 */
         pr_default.execute(1, new Object[] {AV12ProductId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A12ProductId = H001G3_A12ProductId[0];
            A13ProductName = H001G3_A13ProductName[0];
            AssignAttri("", false, "A13ProductName", A13ProductName);
            AV16GXLvl6 = 1;
            Form.Caption = A13ProductName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwproduct.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ProductGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "productgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ProductGeneral";
               WebComp_Generalwc_Component = "ProductGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12ProductId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "ProductProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "productproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "ProductProductWC";
               WebComp_Productwc_Component = "ProductProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12ProductId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product1") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Product1wc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Product1wc_Component), StringUtil.Lower( "ProductProduct1WC")) != 0 )
            {
               WebComp_Product1wc = getWebComponent(GetType(), "GeneXus.Programs", "productproduct1wc", new Object[] {context} );
               WebComp_Product1wc.ComponentInit();
               WebComp_Product1wc.Name = "ProductProduct1WC";
               WebComp_Product1wc_Component = "ProductProduct1WC";
            }
            if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
            {
               WebComp_Product1wc.setjustcreated();
               WebComp_Product1wc.componentprepare(new Object[] {(string)"W0046",(string)"",(short)AV12ProductId});
               WebComp_Product1wc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Product1wc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0046"+"");
               WebComp_Product1wc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ProductId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12ProductId", StringUtil.LTrimStr( (decimal)(AV12ProductId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Product1wc == null ) )
         {
            if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
            {
               WebComp_Product1wc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202352622254752", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproduct.js", "?202352622254752", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblProduct1_title_Internalname = "PRODUCT1_TITLE";
         divTableproduct1_Internalname = "TABLEPRODUCT1";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ProductId',fld:'vPRODUCTID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A13ProductName',fld:'PRODUCTNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         OldProductwc = "";
         lblProduct1_title_Jsonclick = "";
         WebComp_Product1wc_Component = "";
         OldProduct1wc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H001G2_A12ProductId = new short[1] ;
         H001G2_A13ProductName = new string[] {""} ;
         hsh = "";
         H001G3_A12ProductId = new short[1] ;
         H001G3_A13ProductName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproduct__default(),
            new Object[][] {
                new Object[] {
               H001G2_A12ProductId, H001G2_A13ProductName
               }
               , new Object[] {
               H001G3_A12ProductId, H001G3_A13ProductName
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Productwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Product1wc = new GeneXus.Http.GXNullWebComponent();
         AV15Pgmname = "ViewProduct";
         /* GeneXus formulas. */
         AV15Pgmname = "ViewProduct";
         context.Gx_err = 0;
      ...
      private short AV12ProductId ;
      private short wcpOAV12ProductId ;
      ...
      private string lblProduct1_title_Internalname ;
      private string lblProduct1_title_Jsonclick ;
      private string divTableproduct1_Internalname ;
      private string WebComp_Product1wc_Component ;
      private string OldProduct1wc ;
      private string sEvt ;
      ...
      private bool bDynCreated_Product1wc ;
      private GXWebComponent WebComp_Generalwc ;
      private GXWebComponent WebComp_Productwc ;
      private GXWebComponent WebComp_Product1wc ;
      private GXProperties forbiddenHiddens ;
      private GXUserControl ucTab ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private short[] H001G2_A12ProductId ;
      private string[] H001G2_A13ProductName ;
      private short[] H001G3_A12ProductId ;
      private string[] H001G3_A13ProductName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewproduct__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ProductId",GXType.Int16,4,0)
          };
          Object[] prmH001G3;
          ...
          def= new CursorDef[] {
              new CursorDef("H001G2", "SELECT [ProductId], [ProductName] FROM [Product] WHERE [ProductId] = @AV12ProductId ORDER BY [ProductId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001G2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001G3", "SELECT [ProductId], [ProductName] FROM [Product] WHERE [ProductId] = @AV12ProductId ORDER BY [ProductId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001G3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
