...
namespace GeneXus.Programs {
   public class customersandshoppingcarts : GXDataArea
   {
      public customersandshoppingcarts( )
      {
      ...
      public customersandshoppingcarts( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235211522520", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customersandshoppingcarts.aspx") +"\">") ;
      ...
      {
         return formatLink("customersandshoppingcarts.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "CustomersAndShoppingCarts" ;
      }

      public override string GetPgmdesc( )
      {
         return "Customers And Shopping Carts" ;
      }
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table1_15_0L2( true) ;
         }
         else
         {
            wb_table1_15_0L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table2_28_0L2( true) ;
         }
         else
         {
            wb_table2_28_0L2( false) ;
         }
         return  ;
      }

      protected void wb_table2_28_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void START0L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Customers And Shopping Carts", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'DELETE CARTS'") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: 'Delete Carts' */
                              E110L2 ();
                           }
      ...
      protected void STRUP0L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavFromdate_Internalname), 2) == 0 )
            {
            ...
            {
               AV5FromDate = context.localUtil.CToD( cgiGet( edtavFromdate_Internalname), 2);
               AssignAttri("", false, "AV5FromDate", context.localUtil.Format(AV5FromDate, "99/99/99"));
            }
            if ( context.localUtil.VCDate( cgiGet( edtavTodate_Internalname), 2) == 0 )
            {
            ...
            {
               AV6ToDate = context.localUtil.CToD( cgiGet( edtavTodate_Internalname), 2);
               AssignAttri("", false, "AV6ToDate", context.localUtil.Format(AV6ToDate, "99/99/99"));
            }
      ...
      protected void E110L2( )
      {
         ...
         else
         {
            ...
            {
               new deletecarts(context ).execute( ref  AV5FromDate, ref  AV6ToDate) ;
               AssignAttri("", false, "AV5FromDate", context.localUtil.Format(AV5FromDate, "99/99/99"));
               AssignAttri("", false, "AV6ToDate", context.localUtil.Format(AV6ToDate, "99/99/99"));
            }
         }
      ...
      protected void wb_table2_28_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_28_0L2e( true) ;
         }
         else
         {
            wb_table2_28_0L2e( false) ;
         }
      }

      protected void wb_table1_15_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFromdate_Internalname, context.localUtil.Format(AV5FromDate, "99/99/99"), context.localUtil.Format( AV5FromDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFromdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFromdate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_CustomersAndShoppingCarts.htm");
            GxWebStd.gx_bitmap( context, edtavFromdate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFromdate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_CustomersAndShoppingCarts.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTodate_Internalname, context.localUtil.Format(AV6ToDate, "99/99/99"), context.localUtil.Format( AV6ToDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTodate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTodate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_CustomersAndShoppingCarts.htm");
            GxWebStd.gx_bitmap( context, edtavTodate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavTodate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_CustomersAndShoppingCarts.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_15_0L2e( true) ;
         }
         else
         {
            wb_table1_15_0L2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235211522551", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customersandshoppingcarts.js", "?20235211522551", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         bttCustomers_Internalname = "CUSTOMERS";
         bttDeletecarts_Internalname = "DELETECARTS";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Customers And Shopping Carts";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CUSTOMERS'","{handler:'E130L1',iparms:[{av:'AV5FromDate',fld:'vFROMDATE',pic:''},{av:'AV6ToDate',fld:'vTODATE',pic:''}]");
         setEventMetadata("'CUSTOMERS'",",oparms:[{av:'AV6ToDate',fld:'vTODATE',pic:''},{av:'AV5FromDate',fld:'vFROMDATE',pic:''}]}");
         setEventMetadata("'DELETE CARTS'","{handler:'E110L2',iparms:[{av:'AV5FromDate',fld:'vFROMDATE',pic:''},{av:'AV6ToDate',fld:'vTODATE',pic:''}]");
         setEventMetadata("'DELETE CARTS'",",oparms:[{av:'AV6ToDate',fld:'vTODATE',pic:''},{av:'AV5FromDate',fld:'vFROMDATE',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         sStyleString = "";
         TempTags = "";
         bttCustomers_Jsonclick = "";
         bttDeletecarts_Jsonclick = "";
      ...
      private string bttCustomers_Internalname ;
      private string bttCustomers_Jsonclick ;
      private string bttDeletecarts_Internalname ;
      private string bttDeletecarts_Jsonclick ;
