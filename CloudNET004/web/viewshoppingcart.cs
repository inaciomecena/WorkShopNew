...
namespace GeneXus.Programs {
   public class viewshoppingcart : GXDataArea
   {
      ...
      public viewshoppingcart( IGxContext context )
      {
      ...
      public void execute( short aP0_ShoppingCartId ,
                           string aP1_TabCode )
      {
         this.AV12ShoppingCartId = aP0_ShoppingCartId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ShoppingCartId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12ShoppingCartId", StringUtil.LTrimStr( (decimal)(AV12ShoppingCartId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSHOPPINGCARTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ShoppingCartId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235211522234", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewshoppingcart.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ShoppingCartId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ShoppingCartId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewShoppingCart");
         forbiddenHiddens.Add("ShoppingCartDate", context.localUtil.Format(A33ShoppingCartDate, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewshoppingcart:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vSHOPPINGCARTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ShoppingCartId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSHOPPINGCARTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ShoppingCartId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewshoppingcart.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ShoppingCartId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ShoppingCartId","TabCode"})  ;
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Carrinho de Compras Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewShoppingCart.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Carrinho de Compras", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewShoppingCart.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtShoppingCartDate_Internalname, context.localUtil.Format(A33ShoppingCartDate, "99/99/99"), context.localUtil.Format( A33ShoppingCartDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtShoppingCartDate_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtShoppingCartDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ViewShoppingCart.htm");
            GxWebStd.gx_bitmap( context, edtShoppingCartDate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtShoppingCartDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewShoppingCart.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewShoppingCart.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Product", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewShoppingCart.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Shopping Cart", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0F2( )
      {
         ...
         {
            /* Using cursor H000F2 */
            pr_default.execute(0, new Object[] {AV12ShoppingCartId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A16ShoppingCartId = H000F2_A16ShoppingCartId[0];
               A33ShoppingCartDate = H000F2_A33ShoppingCartDate[0];
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ShoppingCartId = (short)(context.localUtil.CToN( cgiGet( "vSHOPPINGCARTID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewshoppingcart:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110F2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000F3 */
         pr_default.execute(1, new Object[] {AV12ShoppingCartId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A16ShoppingCartId = H000F3_A16ShoppingCartId[0];
            A33ShoppingCartDate = H000F3_A33ShoppingCartDate[0];
            AssignAttri("", false, "A33ShoppingCartDate", context.localUtil.Format(A33ShoppingCartDate, "99/99/99"));
            AV16GXLvl6 = 1;
            Form.Caption = context.localUtil.DToC( A33ShoppingCartDate, 2, "/");
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwshoppingcart.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ShoppingCartGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "shoppingcartgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ShoppingCartGeneral";
               WebComp_Generalwc_Component = "ShoppingCartGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12ShoppingCartId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "ShoppingCartProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "shoppingcartproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "ShoppingCartProductWC";
               WebComp_Productwc_Component = "ShoppingCartProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12ShoppingCartId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ShoppingCartId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12ShoppingCartId", StringUtil.LTrimStr( (decimal)(AV12ShoppingCartId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSHOPPINGCARTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ShoppingCartId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235211522291", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewshoppingcart.js", "?20235211522291", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Shopping Cart";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ShoppingCartId',fld:'vSHOPPINGCARTID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A33ShoppingCartDate',fld:'SHOPPINGCARTDATE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000F2_A16ShoppingCartId = new short[1] ;
         H000F2_A33ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000F3_A16ShoppingCartId = new short[1] ;
         H000F3_A33ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewshoppingcart__default(),
            new Object[][] {
                new Object[] {
               H000F2_A16ShoppingCartId, H000F2_A33ShoppingCartDate
               }
               , new Object[] {
               H000F3_A16ShoppingCartId, H000F3_A33ShoppingCartDate
               }
            }
         );
      ...
      private short AV12ShoppingCartId ;
      private short wcpOAV12ShoppingCartId ;
      ...
      private short[] H000F2_A16ShoppingCartId ;
      private DateTime[] H000F2_A33ShoppingCartDate ;
      private short[] H000F3_A16ShoppingCartId ;
      private DateTime[] H000F3_A33ShoppingCartDate ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewshoppingcart__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ShoppingCartId",GXType.Int16,4,0)
          };
          Object[] prmH000F3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT [ShoppingCartId], [ShoppingCartDate] FROM [ShoppingCart] WHERE [ShoppingCartId] = @AV12ShoppingCartId ORDER BY [ShoppingCartId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000F3", "SELECT [ShoppingCartId], [ShoppingCartDate] FROM [ShoppingCart] WHERE [ShoppingCartId] = @AV12ShoppingCartId ORDER BY [ShoppingCartId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
