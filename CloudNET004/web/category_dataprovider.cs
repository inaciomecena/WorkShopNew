...
namespace GeneXus.Programs {
   public class category_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "WorkShopNew") ;
         initialize();
         executePrivate();
      ...
      {
         category_dataprovider objcategory_dataprovider;
         objcategory_dataprovider = new category_dataprovider();
         objcategory_dataprovider.AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "WorkShopNew") ;
         objcategory_dataprovider.context.SetSubmitInitialConfig(context);
         objcategory_dataprovider.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objcategory_dataprovider);
         aP0_ReturnValue=this.AV2ReturnValue;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((category_dataprovider)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "WorkShopNew");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
