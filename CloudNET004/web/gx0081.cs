...
namespace GeneXus.Programs {
   public class gx0081 : GXDataArea
   {
      public gx0081( )
      {
      ...
      public void execute( short aP0_pPromotionId ,
                           out short aP1_pProductId )
      {
         this.AV7pPromotionId = aP0_pPromotionId;
         this.AV8pProductId = 0 ;
         executePrivate();
         aP1_pProductId=this.AV8pProductId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7pPromotionId = (short)(NumberUtil.Val( GetPar( "pPromotionId"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cProductId, AV7pPromotionId) ;
            ...
            {
               AV7pPromotionId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV7pPromotionId", StringUtil.LTrimStr( (decimal)(AV7pPromotionId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pProductId = (short)(NumberUtil.Val( GetPar( "pProductId"), "."));
                  AssignAttri("", false, "AV8pProductId", StringUtil.LTrimStr( (decimal)(AV8pProductId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235211521572", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0081.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pPromotionId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductId,4,0))}, new string[] {"pPromotionId","pProductId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPPROMOTIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pPromotionId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPPRODUCTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pProductId), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx0081.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pPromotionId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductId,4,0))}, new string[] {"pPromotionId","pProductId"})  ;
      }
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductidfilter_Internalname, "Product Id", "", "", lblLblproductidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11101_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0081.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12101_client"+"'", TempTags, "", 2, "HLP_Gx0081.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            if ( Grid1Container.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Promotion Id") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtProductId_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0081.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF102( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {AV7pPromotionId, AV6cProductId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A15PromotionId = H00102_A15PromotionId[0];
               A12ProductId = H00102_A12ProductId[0];
               /* Execute user event: Load */
               E14102 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A12ProductId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {AV7pPromotionId, AV6cProductId});
      ...
      protected void E13102( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Seleção %1", "Product", "", "", "", "", "", "", "", "");
      ...
      protected void E15102( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8pProductId = A12ProductId;
         AssignAttri("", false, "AV8pProductId", StringUtil.LTrimStr( (decimal)(AV8pProductId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV8pProductId});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pProductId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pPromotionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV7pPromotionId", StringUtil.LTrimStr( (decimal)(AV7pPromotionId), 4, 0));
         AV8pProductId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV8pProductId", StringUtil.LTrimStr( (decimal)(AV8pProductId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235211521635", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0081.js", "?20235211521636", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtProductId_Internalname = "PRODUCTID_"+sGXsfl_24_idx;
         edtPromotionId_Internalname = "PROMOTIONID_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_24_fel_idx;
         edtProductId_Internalname = "PRODUCTID_"+sGXsfl_24_fel_idx;
         edtPromotionId_Internalname = "PROMOTIONID_"+sGXsfl_24_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductId',fld:'vCPRODUCTID',pic:'ZZZ9'},{av:'AV7pPromotionId',fld:'vPPROMOTIONID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E12101',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLPRODUCTIDFILTER.CLICK","{handler:'E11101',iparms:[{av:'divProductidfiltercontainer_Class',ctrl:'PRODUCTIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E15102',iparms:[{av:'A12ProductId',fld:'PRODUCTID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pProductId',fld:'vPPRODUCTID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductId',fld:'vCPRODUCTID',pic:'ZZZ9'},{av:'AV7pPromotionId',fld:'vPPROMOTIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductId',fld:'vCPRODUCTID',pic:'ZZZ9'},{av:'AV7pPromotionId',fld:'vPPROMOTIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductId',fld:'vCPRODUCTID',pic:'ZZZ9'},{av:'AV7pPromotionId',fld:'vPPROMOTIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductId',fld:'vCPRODUCTID',pic:'ZZZ9'},{av:'AV7pPromotionId',fld:'vPPROMOTIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Promotionid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00102_A15PromotionId = new short[1] ;
         H00102_A12ProductId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0081__default(),
            new Object[][] {
                new Object[] {
               H00102_A15PromotionId, H00102_A12ProductId
               }
               , new Object[] {
      ...
      private short AV7pPromotionId ;
      private short AV8pProductId ;
      private short wcpOAV7pPromotionId ;
      ...
      private string edtProductId_Link ;
      ...
      private short[] H00102_A15PromotionId ;
      private short[] H00102_A12ProductId ;
   ...
   public class gx0081__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV7pPromotionId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00102", "SELECT [PromotionId], [ProductId] FROM [PromotionProduct] WHERE [PromotionId] = @AV7pPromotionId and [ProductId] >= @AV6cProductId ORDER BY [PromotionId], [ProductId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00102,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00103", "SELECT COUNT(*) FROM [PromotionProduct] WHERE [PromotionId] = @AV7pPromotionId and [ProductId] >= @AV6cProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00103,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
