...
namespace GeneXus.Programs {
   public class wwproduct : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235211524479", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPRODUCTNAME", StringUtil.RTrim( AV11ProductName));
         /* Send saved values. */
      ...
      protected void WB1H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Produtoss", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWProduct.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWProduct.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavProductname_Internalname, "Product Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProductname_Internalname, StringUtil.RTrim( AV11ProductName), StringUtil.RTrim( context.localUtil.Format( AV11ProductName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "do Produto", edtavProductname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavProductname_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWProduct.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Vendedor Nome") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ImageAttribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Foto") ;
               context.WriteHtmlTextNl( "</th>") ;
      ...
      protected void START1H2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Produtoss", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A28ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A28ProductPhoto))), !bGXsfl_25_Refreshing);
                              ...
                              AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40001SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), !bGXsfl_25_Refreshing);
      ...
      protected void RF1H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ProductName = StringUtil.PadR( StringUtil.RTrim( AV11ProductName), 20, "%");
            /* Using cursor H001H2 */
            ...
            {
               A9CountryName = H001H2_A9CountryName[0];
               A8CountryId = H001H2_A8CountryId[0];
               A40001SellerPhoto_GXI = H001H2_A40001SellerPhoto_GXI[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40001SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A19SellerPhoto), true);
               A18SellerName = H001H2_A18SellerName[0];
               A10SellerId = H001H2_A10SellerId[0];
               A7CategoryName = H001H2_A7CategoryName[0];
               A6CategoryId = H001H2_A6CategoryId[0];
               A39ProductCountryName = H001H2_A39ProductCountryName[0];
               A14ProductCountryID = H001H2_A14ProductCountryID[0];
               A40000ProductPhoto_GXI = H001H2_A40000ProductPhoto_GXI[0];
               AssignProp("", false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A28ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A28ProductPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A28ProductPhoto), true);
               A27ProductPrice = H001H2_A27ProductPrice[0];
               A26ProductDescription = H001H2_A26ProductDescription[0];
               A13ProductName = H001H2_A13ProductName[0];
               A12ProductId = H001H2_A12ProductId[0];
               A19SellerPhoto = H001H2_A19SellerPhoto[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40001SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A19SellerPhoto), true);
               A28ProductPhoto = H001H2_A28ProductPhoto[0];
               AssignProp("", false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A28ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A28ProductPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A28ProductPhoto), true);
               A8CountryId = H001H2_A8CountryId[0];
               A40001SellerPhoto_GXI = H001H2_A40001SellerPhoto_GXI[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A12ProductId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235211524622", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwproduct.js", "?20235211524622", false, true);
         }
      ...
      {
         edtProductId_Internalname = "PRODUCTID_"+sGXsfl_25_idx;
         edtProductName_Internalname = "PRODUCTNAME_"+sGXsfl_25_idx;
         edtProductDescription_Internalname = "PRODUCTDESCRIPTION_"+sGXsfl_25_idx;
         edtProductPrice_Internalname = "PRODUCTPRICE_"+sGXsfl_25_idx;
         edtProductPhoto_Internalname = "PRODUCTPHOTO_"+sGXsfl_25_idx;
         edtProductCountryID_Internalname = "PRODUCTCOUNTRYID_"+sGXsfl_25_idx;
         edtProductCountryName_Internalname = "PRODUCTCOUNTRYNAME_"+sGXsfl_25_idx;
         edtCategoryId_Internalname = "CATEGORYID_"+sGXsfl_25_idx;
         edtCategoryName_Internalname = "CATEGORYNAME_"+sGXsfl_25_idx;
         edtSellerId_Internalname = "SELLERID_"+sGXsfl_25_idx;
         edtSellerName_Internalname = "SELLERNAME_"+sGXsfl_25_idx;
         edtSellerPhoto_Internalname = "SELLERPHOTO_"+sGXsfl_25_idx;
      ...
      {
         edtProductId_Internalname = "PRODUCTID_"+sGXsfl_25_fel_idx;
         edtProductName_Internalname = "PRODUCTNAME_"+sGXsfl_25_fel_idx;
         edtProductDescription_Internalname = "PRODUCTDESCRIPTION_"+sGXsfl_25_fel_idx;
         edtProductPrice_Internalname = "PRODUCTPRICE_"+sGXsfl_25_fel_idx;
         edtProductPhoto_Internalname = "PRODUCTPHOTO_"+sGXsfl_25_fel_idx;
         edtProductCountryID_Internalname = "PRODUCTCOUNTRYID_"+sGXsfl_25_fel_idx;
         edtProductCountryName_Internalname = "PRODUCTCOUNTRYNAME_"+sGXsfl_25_fel_idx;
         edtCategoryId_Internalname = "CATEGORYID_"+sGXsfl_25_fel_idx;
         edtCategoryName_Internalname = "CATEGORYNAME_"+sGXsfl_25_fel_idx;
         edtSellerId_Internalname = "SELLERID_"+sGXsfl_25_fel_idx;
         edtSellerName_Internalname = "SELLERNAME_"+sGXsfl_25_fel_idx;
         edtSellerPhoto_Internalname = "SELLERPHOTO_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductCountryID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A14ProductCountryID), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A14ProductCountryID), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductCountryID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoryName_Internalname,StringUtil.RTrim( A7CategoryName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtCategoryName_Link,(string)"",(string)"",(string)"",(string)edtCategoryName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSellerId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A10SellerId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A10SellerId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSellerId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCountryId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A8CountryId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A8CountryId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCountryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ProductName',fld:'vPRODUCTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141H2',iparms:[{av:'A12ProductId',fld:'PRODUCTID',pic:'ZZZ9',hsh:true},{av:'A6CategoryId',fld:'CATEGORYID',pic:'ZZZ9'},{av:'A10SellerId',fld:'SELLERID',pic:'ZZZ9'},{av:'A8CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtProductName_Link',ctrl:'PRODUCTNAME',prop:'Link'},{av:'edtCategoryName_Link',ctrl:'CATEGORYNAME',prop:'Link'},{av:'edtSellerName_Link',ctrl:'SELLERNAME',prop:'Link'},{av:'edtCountryName_Link',ctrl:'COUNTRYNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111H2',iparms:[{av:'A12ProductId',fld:'PRODUCTID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ProductName',fld:'vPRODUCTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ProductName',fld:'vPRODUCTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ProductName',fld:'vPRODUCTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ProductName',fld:'vPRODUCTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11ProductName = "";
         H001H2_A9CountryName = new string[] {""} ;
         H001H2_A8CountryId = new short[1] ;
         H001H2_A40001SellerPhoto_GXI = new string[] {""} ;
         H001H2_A18SellerName = new string[] {""} ;
         H001H2_A10SellerId = new short[1] ;
         H001H2_A7CategoryName = new string[] {""} ;
         H001H2_A6CategoryId = new short[1] ;
         H001H2_A39ProductCountryName = new string[] {""} ;
         H001H2_A14ProductCountryID = new short[1] ;
         H001H2_A40000ProductPhoto_GXI = new string[] {""} ;
         H001H2_A27ProductPrice = new decimal[1] ;
         H001H2_A26ProductDescription = new string[] {""} ;
         H001H2_A13ProductName = new string[] {""} ;
         H001H2_A12ProductId = new short[1] ;
         H001H2_A19SellerPhoto = new string[] {""} ;
         H001H2_A28ProductPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwproduct__default(),
            new Object[][] {
                new Object[] {
               H001H2_A9CountryName, H001H2_A8CountryId, H001H2_A40001SellerPhoto_GXI, H001H2_A18SellerName, H001H2_A10SellerId, H001H2_A7CategoryName, H001H2_A6CategoryId, H001H2_A39ProductCountryName, H001H2_A14ProductCountryID, H001H2_A40000ProductPhoto_GXI,
               H001H2_A27ProductPrice, H001H2_A26ProductDescription, H001H2_A13ProductName, H001H2_A12ProductId, H001H2_A19SellerPhoto, H001H2_A28ProductPhoto
               }
               , new Object[] {
      ...
      private string[] H001H2_A9CountryName ;
      private short[] H001H2_A8CountryId ;
      private string[] H001H2_A40001SellerPhoto_GXI ;
      private string[] H001H2_A18SellerName ;
      private short[] H001H2_A10SellerId ;
      private string[] H001H2_A7CategoryName ;
      private short[] H001H2_A6CategoryId ;
      private string[] H001H2_A39ProductCountryName ;
      private short[] H001H2_A14ProductCountryID ;
      private string[] H001H2_A40000ProductPhoto_GXI ;
      private decimal[] H001H2_A27ProductPrice ;
      private string[] H001H2_A26ProductDescription ;
      private string[] H001H2_A13ProductName ;
      private short[] H001H2_A12ProductId ;
      private string[] H001H2_A19SellerPhoto ;
      private string[] H001H2_A28ProductPhoto ;
   ...
   public class wwproduct__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A13ProductName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T3.[CountryName], T2.[CountryId], T2.[SellerPhoto_GXI], T2.[SellerName], T1.[SellerId], T4.[CategoryName], T1.[CategoryId], T5.[CountryName] AS ProductCountryName, T1.[ProductCountryID] AS ProductCountryID, T1.[ProductPhoto_GXI], T1.[ProductPrice], T1.[ProductDescription], T1.[ProductName], T1.[ProductId], T2.[SellerPhoto], T1.[ProductPhoto]";
         sFromString = " FROM (((([Product] T1 INNER JOIN [Seller] T2 ON T2.[SellerId] = T1.[SellerId]) INNER JOIN [Country] T3 ON T3.[CountryId] = T2.[CountryId]) INNER JOIN [Category] T4 ON T4.[CategoryId] = T1.[CategoryId]) INNER JOIN [Country] T5 ON T5.[CountryId] = T1.[ProductCountryID])";
         sOrderString = "";
                                             ...
                                             string A13ProductName )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (((([Product] T1 INNER JOIN [Seller] T3 ON T3.[SellerId] = T1.[SellerId]) INNER JOIN [Country] T4 ON T4.[CountryId] = T3.[CountryId]) INNER JOIN [Category] T2 ON T2.[CategoryId] = T1.[CategoryId]) INNER JOIN [Country] T5 ON T5.[CountryId] = T1.[ProductCountryID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ProductName)) )
         {
            AddWhere(sWhereString, "(T1.[ProductName] like @lV11ProductName)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001H2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H001H3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ProductName",GXType.NChar,20,0) ,
