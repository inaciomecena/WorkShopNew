...
namespace GeneXus.Programs {
   public class viewseller : GXDataArea
   {
      public viewseller( )
      {
      ...
      public viewseller( IGxContext context )
      {
      ...
      public void execute( short aP0_SellerId ,
                           string aP1_TabCode )
      {
         this.AV12SellerId = aP0_SellerId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12SellerId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12SellerId", StringUtil.LTrimStr( (decimal)(AV12SellerId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSELLERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SellerId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202352622254049", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewseller.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SellerId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SellerId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewSeller");
         forbiddenHiddens.Add("SellerName", StringUtil.RTrim( context.localUtil.Format( A18SellerName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewseller:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vSELLERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12SellerId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSELLERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SellerId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewseller.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SellerId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SellerId","TabCode"})  ;
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Vendedores Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewSeller.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Vendedores", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewSeller.htm");
            ...
            GxWebStd.gx_label_element( context, edtSellerName_Internalname, "Vendedor", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSellerName_Internalname, StringUtil.RTrim( A18SellerName), StringUtil.RTrim( context.localUtil.Format( A18SellerName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtSellerName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewSeller.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSeller.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Produtos", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSeller.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0Q2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Seller", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0Q2( )
      {
         ...
         {
            /* Using cursor H000Q2 */
            pr_default.execute(0, new Object[] {AV12SellerId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A10SellerId = H000Q2_A10SellerId[0];
               A18SellerName = H000Q2_A18SellerName[0];
      ...
      protected void STRUP0Q0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12SellerId = (short)(context.localUtil.CToN( cgiGet( "vSELLERID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewseller:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110Q2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000Q3 */
         pr_default.execute(1, new Object[] {AV12SellerId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A10SellerId = H000Q3_A10SellerId[0];
            A18SellerName = H000Q3_A18SellerName[0];
            AssignAttri("", false, "A18SellerName", A18SellerName);
            AV16GXLvl6 = 1;
            Form.Caption = A18SellerName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwseller.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "SellerGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "sellergeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "SellerGeneral";
               WebComp_Generalwc_Component = "SellerGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12SellerId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "SellerProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "sellerproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "SellerProductWC";
               WebComp_Productwc_Component = "SellerProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12SellerId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12SellerId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12SellerId", StringUtil.LTrimStr( (decimal)(AV12SellerId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSELLERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SellerId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202352622254095", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewseller.js", "?202352622254096", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12SellerId',fld:'vSELLERID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A18SellerName',fld:'SELLERNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000Q2_A10SellerId = new short[1] ;
         H000Q2_A18SellerName = new string[] {""} ;
         hsh = "";
         H000Q3_A10SellerId = new short[1] ;
         H000Q3_A18SellerName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewseller__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A10SellerId, H000Q2_A18SellerName
               }
               , new Object[] {
               H000Q3_A10SellerId, H000Q3_A18SellerName
               }
            }
         );
      ...
      private short AV12SellerId ;
      private short wcpOAV12SellerId ;
      ...
      private short[] H000Q2_A10SellerId ;
      private string[] H000Q2_A18SellerName ;
      private short[] H000Q3_A10SellerId ;
      private string[] H000Q3_A18SellerName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewseller__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12SellerId",GXType.Int16,4,0)
          };
          Object[] prmH000Q3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000Q2", "SELECT [SellerId], [SellerName] FROM [Seller] WHERE [SellerId] = @AV12SellerId ORDER BY [SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000Q3", "SELECT [SellerId], [SellerName] FROM [Seller] WHERE [SellerId] = @AV12SellerId ORDER BY [SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
