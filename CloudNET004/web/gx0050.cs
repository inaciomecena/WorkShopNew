...
namespace GeneXus.Programs {
   public class gx0050 : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023521151564", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0050.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV11pCustomerId,4,0))}, new string[] {"pCustomerId"}) +"\">") ;
      ...
      {
         return formatLink("gx0050.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV11pCustomerId,4,0))}, new string[] {"pCustomerId"})  ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e160x1_client"+"'", TempTags, "", 2, "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A23CustomerPhone));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 64 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0050.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A22CustomerEmail = H000X2_A22CustomerEmail[0];
               A8CountryId = H000X2_A8CountryId[0];
               A23CustomerPhone = H000X2_A23CustomerPhone[0];
               A20CustomerName = H000X2_A20CustomerName[0];
               A11CustomerId = H000X2_A11CustomerId[0];
               /* Execute user event: Load */
               E180X2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CUSTOMERID"+"_"+sGXsfl_64_idx, GetSecureSignedToken( sGXsfl_64_idx, context.localUtil.Format( (decimal)(A11CustomerId), "ZZZ9"), context));
      }
      ...
      protected void E170X2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Seleção %1", "Customer", "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235211515785", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0050.js", "?20235211515787", false, true);
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A11CustomerId), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtCustomerName_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A11CustomerId), 4, 0, ",", "")))+"'"+"]);";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLCUSTOMERIDFILTER.CLICK","{handler:'E110X1',iparms:[{av:'divCustomeridfiltercontainer_Class',ctrl:'CUSTOMERIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCUSTOMERNAMEFILTER.CLICK","{handler:'E120X1',iparms:[{av:'divCustomernamefiltercontainer_Class',ctrl:'CUSTOMERNAMEFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCUSTOMEREMAILFILTER.CLICK","{handler:'E130X1',iparms:[{av:'divCustomeremailfiltercontainer_Class',ctrl:'CUSTOMEREMAILFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCUSTOMERPHONEFILTER.CLICK","{handler:'E140X1',iparms:[{av:'divCustomerphonefiltercontainer_Class',ctrl:'CUSTOMERPHONEFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCOUNTRYIDFILTER.CLICK","{handler:'E150X1',iparms:[{av:'divCountryidfiltercontainer_Class',ctrl:'COUNTRYIDFILTERCONTAINER',prop:'Class'}]");
      ...
      public override void initialize( )
      {
         ...
         lV9cCustomerPhone = "";
         A22CustomerEmail = "";
         H000X2_A22CustomerEmail = new string[] {""} ;
         H000X2_A8CountryId = new short[1] ;
         H000X2_A23CustomerPhone = new string[] {""} ;
         H000X2_A20CustomerName = new string[] {""} ;
         H000X2_A11CustomerId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0050__default(),
            new Object[][] {
                new Object[] {
               H000X2_A22CustomerEmail, H000X2_A8CountryId, H000X2_A23CustomerPhone, H000X2_A20CustomerName, H000X2_A11CustomerId
               }
               , new Object[] {
      ...
      private string[] H000X2_A22CustomerEmail ;
      private short[] H000X2_A8CountryId ;
      private string[] H000X2_A23CustomerPhone ;
      private string[] H000X2_A20CustomerName ;
      private short[] H000X2_A11CustomerId ;
   ...
   public class gx0050__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000X2( IGxContext context ,
                                             ...
                                             string A22CustomerEmail ,
                                             string A23CustomerPhone ,
                                             short A8CountryId ,
                                             short AV6cCustomerId )
      {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000X2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H000X3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
         }
