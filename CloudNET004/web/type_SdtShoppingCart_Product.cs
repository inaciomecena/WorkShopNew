...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "ShoppingCart.Product" , Namespace = "WorkShopNew" )]
   [Serializable]
   ...
   [DataContract(Name = @"ShoppingCart.Product", Namespace = "WorkShopNew")]
   public class SdtShoppingCart_Product_RESTInterface : GxGenericCollectionItem<SdtShoppingCart_Product>
   {
      ...
      {
         get {
            return StringUtil.LTrim( StringUtil.Str( sdt.gxTpr_Totalproduct, 8, 2)) ;
         }
