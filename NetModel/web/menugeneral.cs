...
namespace GeneXus.Programs {
   public class menugeneral : GXWebComponent
   {
      public menugeneral( )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235182294073", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("menugeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1MenuXid,4,0))}, new string[] {"MenuXid"}) +"\">") ;
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modifica", bttBtnupdate_Jsonclick, 7, "Modifica", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110d1_client"+"'", TempTags, "", 2, "HLP_MenuGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120d1_client"+"'", TempTags, "", 2, "HLP_MenuGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMenuXPosi_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A3MenuXPosi), 4, 0, ",", "")), StringUtil.LTrim( ((edtMenuXPosi_Enabled!=0) ? context.localUtil.Format( (decimal)(A3MenuXPosi), "ZZZ9") : context.localUtil.Format( (decimal)(A3MenuXPosi), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMenuXPosi_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtMenuXPosi_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_MenuGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbMenXEst, cmbMenXEst_Internalname, StringUtil.RTrim( A5MenXEst), 1, cmbMenXEst_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbMenXEst.Enabled, 0, 0, 0, "em", 0, "", "", "ReadonlyAttribute", "", "", "", "", true, 1, "HLP_MenuGeneral.htm");
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5MenXEst = H000D2_A5MenXEst[0];
               n5MenXEst = H000D2_n5MenXEst[0];
               AssignAttri(sPrefix, false, "A5MenXEst", A5MenXEst);
               A4MenXUrl = H000D2_A4MenXUrl[0];
               n4MenXUrl = H000D2_n4MenXUrl[0];
               AssignAttri(sPrefix, false, "A4MenXUrl", A4MenXUrl);
               A3MenuXPosi = H000D2_A3MenuXPosi[0];
               n3MenuXPosi = H000D2_n3MenuXPosi[0];
               AssignAttri(sPrefix, false, "A3MenuXPosi", StringUtil.LTrimStr( (decimal)(A3MenuXPosi), 4, 0));
               A2MenuXDesc = H000D2_A2MenuXDesc[0];
               n2MenuXDesc = H000D2_n2MenuXDesc[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235182294142", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("menugeneral.js", "?20235182294143", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E110D1',iparms:[{av:'A1MenuXid',fld:'MENUXID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120D1',iparms:[{av:'A1MenuXid',fld:'MENUXID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000D2_A1MenuXid = new short[1] ;
         H000D2_A5MenXEst = new string[] {""} ;
         H000D2_n5MenXEst = new bool[] {false} ;
         H000D2_A4MenXUrl = new string[] {""} ;
         H000D2_n4MenXUrl = new bool[] {false} ;
         H000D2_A3MenuXPosi = new short[1] ;
         H000D2_n3MenuXPosi = new bool[] {false} ;
         H000D2_A2MenuXDesc = new string[] {""} ;
         H000D2_n2MenuXDesc = new bool[] {false} ;
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.menugeneral__default(),
            new Object[][] {
                new Object[] {
               H000D2_A1MenuXid, H000D2_A5MenXEst, H000D2_n5MenXEst, H000D2_A4MenXUrl, H000D2_n4MenXUrl, H000D2_A3MenuXPosi, H000D2_n3MenuXPosi, H000D2_A2MenuXDesc, H000D2_n2MenuXDesc
               }
            }
         );
         AV13Pgmname = "MenuGeneral";
      ...
      private short[] H000D2_A1MenuXid ;
      private string[] H000D2_A5MenXEst ;
      private bool[] H000D2_n5MenXEst ;
      private string[] H000D2_A4MenXUrl ;
      private bool[] H000D2_n4MenXUrl ;
      private short[] H000D2_A3MenuXPosi ;
      private bool[] H000D2_n3MenuXPosi ;
      private string[] H000D2_A2MenuXDesc ;
      private bool[] H000D2_n2MenuXDesc ;
   ...
   public class menugeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [MenuXid], [MenXEst], [MenXUrl], [MenuXPosi], [MenuXDesc] FROM [Menu] WHERE [MenuXid] = @MenuXid ORDER BY [MenuXid] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
