...
namespace GeneXus.Programs {
   public class recentlinks : GXWebComponent
   {
      public recentlinks( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               {
                  nRC_GXsfl_7 = (int)(NumberUtil.Val( GetPar( "nRC_GXsfl_7"), "."));
                  nGXsfl_7_idx = (int)(NumberUtil.Val( GetPar( "nGXsfl_7_idx"), "."));
                  sGXsfl_7_idx = GetPar( "sGXsfl_7_idx");
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235182293850", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("recentlinks.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6FormCaption)),UrlEncode(StringUtil.RTrim(AV7FormPgmName))}, new string[] {"FormCaption","FormPgmName"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_7", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_7), 8, 0, ",", "")));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "LINKS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              nGXsfl_7_idx = (int)(NumberUtil.Val( sEvtType, "."));
                              sGXsfl_7_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_7_idx), 4, 0), 4, "0");
      ...
      protected void STRUP020( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_7 = (int)(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_7"), ",", "."));
      ...
      protected void E11022( )
      {
         ...
         returnInSub = false;
         lblPipe_Caption = "|";
         AssignProp(sPrefix, false, lblPipe_Internalname, "Caption", lblPipe_Caption, !bGXsfl_7_Refreshing);
      }
      ...
      private void E12022( )
      {
         /* Links_Load Routine */
         returnInSub = false;
         AV11RecentLinksItems.FromXml(AV8Session.Get("RecentLinks"), null, "LinkList", "");
         AV9i = 1;
         ...
         AV8Session.Set("RecentLinks", AV11RecentLinksItems.ToXml(false, true, "LinkList", ""));
         AV9i = 1;
         while ( AV9i <= AV11RecentLinksItems.Count )
         {
            AV12RecentLinksItem = ((SdtLinkList_LinkItem)AV11RecentLinksItems.Item(AV9i));
      ...
      protected void wb_table1_2_022( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRecenttext_Internalname, "Recents: ", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RecentLink", 0, "", 1, 1, 0, 0, "HLP_RecentLinks.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /*  Grid Control  */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "recentlinks", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023518229392", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?2023518229393", false, true);
         }
      ...
      protected void sendrow_72( )
      {
         ...
         LinksRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         /* Text block */
         ...
         LinksRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",""+" style=\""+CSSHelper.Prettify( "width:4px")+"\"",(string)"td100"});
         /* Text block */
         LinksRow.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {(string)lblPipe_Internalname,(string)lblPipe_Caption,(string)"",(string)"",(string)lblPipe_Jsonclick,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"RecentLinkItem",(short)0,(string)"",(short)1,(short)1,(short)0,(short)0});
         if ( LinksContainer.GetWrapped() == 1 )
         {
            LinksContainer.CloseTag("cell");
         }
      ...
      private bool Rfr0gs ;
      private bool wbErr ;
      private bool bGXsfl_7_Refreshing=false ;
