...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Country" , Namespace = "WorkShopNew" )]
   [Serializable]
   public class SdtCountry : GxSilentTrnSdt
   {
      public SdtCountry( )
      {
      }
      ...
      public void Load( short AV8CountryId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV8CountryId});
         return  ;
      }
   ...
   [DataContract(Name = @"Country", Namespace = "WorkShopNew")]
   public class SdtCountry_RESTInterface : GxGenericCollectionItem<SdtCountry>
   {
   ...
   [DataContract(Name = @"Country", Namespace = "WorkShopNew")]
   public class SdtCountry_RESTLInterface : GxGenericCollectionItem<SdtCountry>
   {
