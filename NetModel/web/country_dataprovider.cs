...
namespace GeneXus.Programs {
   public class country_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtCountry>( context, "Country", "WorkShopNew") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBCCollection<SdtCountry> aP0_ReturnValue )
      {
         ...
         objcountry_dataprovider.AV2ReturnValue = new GXBCCollection<SdtCountry>( context, "Country", "WorkShopNew") ;
         objcountry_dataprovider.context.SetSubmitInitialConfig(context);
         objcountry_dataprovider.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objcountry_dataprovider);
         aP0_ReturnValue=this.AV2ReturnValue;
      }
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtCountry>( context, "Country", "WorkShopNew");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
