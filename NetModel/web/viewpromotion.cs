   ...
   public class viewpromotion : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12PromotionId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351923485783", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("PromotionDescription", StringUtil.RTrim( context.localUtil.Format( A29PromotionDescription, "")));
      ...
      protected void WB1L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Promotion Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewPromotion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Promotions", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewPromotion.htm");
      ...
      protected void RF1L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15PromotionId = H001L2_A15PromotionId[0];
               A29PromotionDescription = H001L2_A29PromotionDescription[0];
      ...
      protected void STRUP1L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12PromotionId = (short)(context.localUtil.CToN( cgiGet( "vPROMOTIONID"), ",", "."));
      ...
      protected void E111L2( )
      {
         ...
         {
            A15PromotionId = H001L3_A15PromotionId[0];
            A29PromotionDescription = H001L3_A29PromotionDescription[0];
            AssignAttri("", false, "A29PromotionDescription", A29PromotionDescription);
            AV16GXLvl6 = 1;
            Form.Caption = A29PromotionDescription;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12PromotionId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               ...
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12PromotionId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351923485828", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpromotion.js", "?202351923485828", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12PromotionId',fld:'vPROMOTIONID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A29PromotionDescription',fld:'PROMOTIONDESCRIPTION',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H001L2_A15PromotionId = new short[1] ;
         H001L2_A29PromotionDescription = new string[] {""} ;
         hsh = "";
         H001L3_A15PromotionId = new short[1] ;
         H001L3_A29PromotionDescription = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpromotion__default(),
            new Object[][] {
                new Object[] {
               H001L2_A15PromotionId, H001L2_A29PromotionDescription
               }
               , new Object[] {
               H001L3_A15PromotionId, H001L3_A29PromotionDescription
               }
            }
         );
      ...
      private short[] H001L2_A15PromotionId ;
      private string[] H001L2_A29PromotionDescription ;
      private short[] H001L3_A15PromotionId ;
      private string[] H001L3_A29PromotionDescription ;
   ...
   public class viewpromotion__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001L2", "SELECT [PromotionId], [PromotionDescription] FROM [Promotion] WHERE [PromotionId] = @AV12PromotionId ORDER BY [PromotionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001L2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001L3", "SELECT [PromotionId], [PromotionDescription] FROM [Promotion] WHERE [PromotionId] = @AV12PromotionId ORDER BY [PromotionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001L3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
