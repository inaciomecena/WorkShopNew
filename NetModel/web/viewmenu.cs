...
namespace GeneXus.Programs {
   public class viewmenu : GXDataArea
   {
      public viewmenu( )
      {
      ...
      public viewmenu( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "MenuXid");
            ...
            {
               AV12MenuXid = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12MenuXid", StringUtil.LTrimStr( (decimal)(AV12MenuXid), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vMENUXID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12MenuXid), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351822112363", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewmenu.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12MenuXid,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"MenuXid","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewMenu");
         forbiddenHiddens.Add("MenuXDesc", StringUtil.RTrim( context.localUtil.Format( A2MenuXDesc, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewmenu:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMENUXID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12MenuXid), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vMENUXID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12MenuXid), "ZZZ9"), context));
      ...
      {
         return formatLink("viewmenu.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12MenuXid,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"MenuXid","TabCode"})  ;
      }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Menu Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewMenu.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Menus", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewMenu.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMenuXDesc_Internalname, A2MenuXDesc, StringUtil.RTrim( context.localUtil.Format( A2MenuXDesc, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMenuXDesc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtMenuXDesc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewMenu.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewMenu.htm");
            /* Div Control */
      ...
      protected void START0B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Menu", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0B2( )
      {
         ...
         {
            /* Using cursor H000B2 */
            pr_default.execute(0, new Object[] {AV12MenuXid});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A1MenuXid = H000B2_A1MenuXid[0];
               A2MenuXDesc = H000B2_A2MenuXDesc[0];
               n2MenuXDesc = H000B2_n2MenuXDesc[0];
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12MenuXid = (short)(context.localUtil.CToN( cgiGet( "vMENUXID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewmenu:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110B2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {AV12MenuXid});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A1MenuXid = H000B3_A1MenuXid[0];
            A2MenuXDesc = H000B3_A2MenuXDesc[0];
            n2MenuXDesc = H000B3_n2MenuXDesc[0];
            AssignAttri("", false, "A2MenuXDesc", A2MenuXDesc);
            AV16GXLvl6 = 1;
            Form.Caption = A2MenuXDesc;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwmenu.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "MenuGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "menugeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "MenuGeneral";
               WebComp_Generalwc_Component = "MenuGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12MenuXid});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12MenuXid = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12MenuXid", StringUtil.LTrimStr( (decimal)(AV12MenuXid), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vMENUXID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12MenuXid), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351822112423", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewmenu.js", "?202351822112424", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12MenuXid',fld:'vMENUXID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2MenuXDesc',fld:'MENUXDESC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000B2_A1MenuXid = new short[1] ;
         H000B2_A2MenuXDesc = new string[] {""} ;
         H000B2_n2MenuXDesc = new bool[] {false} ;
         hsh = "";
         H000B3_A1MenuXid = new short[1] ;
         H000B3_A2MenuXDesc = new string[] {""} ;
         H000B3_n2MenuXDesc = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewmenu__default(),
            new Object[][] {
                new Object[] {
               H000B2_A1MenuXid, H000B2_A2MenuXDesc, H000B2_n2MenuXDesc
               }
               , new Object[] {
               H000B3_A1MenuXid, H000B3_A2MenuXDesc, H000B3_n2MenuXDesc
               }
            }
         );
      ...
      private short AV12MenuXid ;
      private short wcpOAV12MenuXid ;
      ...
      private short[] H000B2_A1MenuXid ;
      private string[] H000B2_A2MenuXDesc ;
      private bool[] H000B2_n2MenuXDesc ;
      private short[] H000B3_A1MenuXid ;
      private string[] H000B3_A2MenuXDesc ;
      private bool[] H000B3_n2MenuXDesc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewmenu__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12MenuXid",GXType.Int16,4,0)
          };
          Object[] prmH000B3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT [MenuXid], [MenuXDesc] FROM [Menu] WHERE [MenuXid] = @AV12MenuXid ORDER BY [MenuXid] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000B3", "SELECT [MenuXid], [MenuXDesc] FROM [Menu] WHERE [MenuXid] = @AV12MenuXid ORDER BY [MenuXid] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
