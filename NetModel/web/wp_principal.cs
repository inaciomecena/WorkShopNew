...
namespace GeneXus.Programs {
   public class wp_principal : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm1P2( )
      {
         ...
         context.AddJavascriptSource("wp_principal.js", "?202352021564325", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202352021564337", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wp_principal.js", "?202352021564338", false, true);
         }
