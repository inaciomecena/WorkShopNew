   ...
   public class acategoriesandproductsproc : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A7CategoryName, "")), 350, Gx_line+80, 517, Gx_line+107, 0, 0, 0, 0) ;
            getPrinter().GxDrawText("And Products", 480, Gx_line+80, 630, Gx_line+106, 0, 0, 0, 0) ;
            getPrinter().GxDrawLine(8, Gx_line+218, 825, Gx_line+218, 2, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 12, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText("Seller", 575, Gx_line+200, 618, Gx_line+221, 0+256, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               H0G0( false, 82) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 12, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( A27ProductPrice, "$ ZZZZ9.99")), 283, Gx_line+0, 378, Gx_line+22, 2+256, 0, 0, 0) ;
            ...
            if ( AV4GXLvl2 == 0 )
            {
               ...
               getPrinter().GxDrawText("No hay productos en esta categoria!", 58, Gx_line+17, 765, Gx_line+90, 0, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
