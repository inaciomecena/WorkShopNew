...
namespace GeneXus.Programs {
   public class productspercategory : GXProcedure
   {
      ...
      public void executeSubmit( )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objproductspercategory);
      }
      ...
      void executePrivate( )
      {
         ...
         args = new Object[] {} ;
         ClassLoader.Execute("aproductspercategory","GeneXus.Programs","aproductspercategory", new Object[] {context }, "execute", args);
         this.cleanup();
      }
