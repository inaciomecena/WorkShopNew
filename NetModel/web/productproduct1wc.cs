...
namespace GeneXus.Programs {
   public class productproduct1wc : GXWebComponent
   {
      public productproduct1wc( )
      {
      ...
      public productproduct1wc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6ProductId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Product Product1 WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351923482937", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("productproduct1wc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ProductId,4,0))}, new string[] {"ProductId"}) +"\">") ;
      ...
      {
         return "ProductProduct1WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Product Product1 WC" ;
      }
      ...
      protected void WB1K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productproduct1wc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProductProduct1WC.htm");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Customer Address") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Customer Phone") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      protected void START1K2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Product Product1 WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A12ProductId = H001K3_A12ProductId[0];
               AssignAttri(sPrefix, false, "A12ProductId", StringUtil.LTrimStr( (decimal)(A12ProductId), 4, 0));
               A23CustomerPhone = H001K3_A23CustomerPhone[0];
               A21CustomerAddress = H001K3_A21CustomerAddress[0];
               A9CountryName = H001K3_A9CountryName[0];
               A8CountryId = H001K3_A8CountryId[0];
               A20CustomerName = H001K3_A20CustomerName[0];
               A11CustomerId = H001K3_A11CustomerId[0];
               A16ShoppingCartId = H001K3_A16ShoppingCartId[0];
               A34ShoppingCartFinalPrice = H001K3_A34ShoppingCartFinalPrice[0];
               n34ShoppingCartFinalPrice = H001K3_n34ShoppingCartFinalPrice[0];
               A33ShoppingCartDate = H001K3_A33ShoppingCartDate[0];
               A11CustomerId = H001K3_A11CustomerId[0];
               A33ShoppingCartDate = H001K3_A33ShoppingCartDate[0];
               A23CustomerPhone = H001K3_A23CustomerPhone[0];
               A21CustomerAddress = H001K3_A21CustomerAddress[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H001K5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productproduct1wc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351923483077", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("productproduct1wc.js", "?202351923483077", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ProductId',fld:'vPRODUCTID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131K2',iparms:[{av:'A16ShoppingCartId',fld:'SHOPPINGCARTID',pic:'ZZZ9',hsh:true},{av:'A11CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'A8CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtShoppingCartDate_Link',ctrl:'SHOPPINGCARTDATE',prop:'Link'},{av:'edtCustomerName_Link',ctrl:'CUSTOMERNAME',prop:'Link'},{av:'edtCountryName_Link',ctrl:'COUNTRYNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111K2',iparms:[{av:'A16ShoppingCartId',fld:'SHOPPINGCARTID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ProductId',fld:'vPRODUCTID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ProductId',fld:'vPRODUCTID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ProductId',fld:'vPRODUCTID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ProductId',fld:'vPRODUCTID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001K3_A12ProductId = new short[1] ;
         H001K3_A23CustomerPhone = new string[] {""} ;
         H001K3_A21CustomerAddress = new string[] {""} ;
         H001K3_A9CountryName = new string[] {""} ;
         H001K3_A8CountryId = new short[1] ;
         H001K3_A20CustomerName = new string[] {""} ;
         H001K3_A11CustomerId = new short[1] ;
         H001K3_A16ShoppingCartId = new short[1] ;
         H001K3_A34ShoppingCartFinalPrice = new decimal[1] ;
         H001K3_n34ShoppingCartFinalPrice = new bool[] {false} ;
         H001K3_A33ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         H001K5_AGRID_nRecordCount = new long[1] ;
         ...
         ROClassString = "";
         gxphoneLink = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productproduct1wc__default(),
            new Object[][] {
                new Object[] {
               H001K3_A12ProductId, H001K3_A23CustomerPhone, H001K3_A21CustomerAddress, H001K3_A9CountryName, H001K3_A8CountryId, H001K3_A20CustomerName, H001K3_A11CustomerId, H001K3_A16ShoppingCartId, H001K3_A34ShoppingCartFinalPrice, H001K3_n34ShoppingCartFinalPrice,
               H001K3_A33ShoppingCartDate
               }
               , new Object[] {
               H001K5_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ProductProduct1WC";
      ...
      private short[] H001K3_A12ProductId ;
      private string[] H001K3_A23CustomerPhone ;
      private string[] H001K3_A21CustomerAddress ;
      private string[] H001K3_A9CountryName ;
      private short[] H001K3_A8CountryId ;
      private string[] H001K3_A20CustomerName ;
      private short[] H001K3_A11CustomerId ;
      private short[] H001K3_A16ShoppingCartId ;
      private decimal[] H001K3_A34ShoppingCartFinalPrice ;
      private bool[] H001K3_n34ShoppingCartFinalPrice ;
      private DateTime[] H001K3_A33ShoppingCartDate ;
      private long[] H001K5_AGRID_nRecordCount ;
   ...
   public class productproduct1wc__default : DataStoreHelperBase, IDataStoreHelper
   {
