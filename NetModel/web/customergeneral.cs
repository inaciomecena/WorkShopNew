...
namespace GeneXus.Programs {
   public class customergeneral : GXWebComponent
   {
      ...
      {
         this.A11CustomerId = aP0_CustomerId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A11CustomerId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351923484115", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customergeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A11CustomerId,4,0))}, new string[] {"CustomerId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA11CustomerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA11CustomerId), 4, 0, ",", "")));
      }
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modifica", bttBtnupdate_Jsonclick, 7, "Modifica", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111e1_client"+"'", TempTags, "", 2, "HLP_CustomerGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e121e1_client"+"'", TempTags, "", 2, "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtCustomerAddress_Internalname, "Address", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtCustomerAddress_Internalname, A21CustomerAddress, "http://maps.google.com/maps?q="+GXUtil.UrlEncode( A21CustomerAddress), "", 0, 1, edtCustomerAddress_Enabled, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "", "1024", -1, 0, "_blank", "", 0, true, "GeneXus\\Address", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerEmail_Internalname, A22CustomerEmail, StringUtil.RTrim( context.localUtil.Format( A22CustomerEmail, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "mailto:"+A22CustomerEmail, "", "", "", edtCustomerEmail_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCustomerEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "GeneXus\\Email", "left", true, "", "HLP_CustomerGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF1E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9CountryName = H001E2_A9CountryName[0];
               AssignAttri(sPrefix, false, "A9CountryName", A9CountryName);
               A8CountryId = H001E2_A8CountryId[0];
               AssignAttri(sPrefix, false, "A8CountryId", StringUtil.LTrimStr( (decimal)(A8CountryId), 4, 0));
               A23CustomerPhone = H001E2_A23CustomerPhone[0];
               AssignAttri(sPrefix, false, "A23CustomerPhone", A23CustomerPhone);
               A22CustomerEmail = H001E2_A22CustomerEmail[0];
               AssignAttri(sPrefix, false, "A22CustomerEmail", A22CustomerEmail);
               A21CustomerAddress = H001E2_A21CustomerAddress[0];
               AssignAttri(sPrefix, false, "A21CustomerAddress", A21CustomerAddress);
               A20CustomerName = H001E2_A20CustomerName[0];
      ...
      protected void STRUP1E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA11CustomerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA11CustomerId"), ",", "."));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A11CustomerId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A11CustomerId", StringUtil.LTrimStr( (decimal)(A11CustomerId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA11CustomerId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A11CustomerId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A11CustomerId", StringUtil.LTrimStr( (decimal)(A11CustomerId), 4, 0));
         }
         wcpOA11CustomerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA11CustomerId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A11CustomerId != wcpOA11CustomerId ) ) )
         {
            setjustcreated();
         }
         wcpOA11CustomerId = A11CustomerId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA11CustomerId = cgiGet( sPrefix+"A11CustomerId_CTRL");
         if ( StringUtil.Len( sCtrlA11CustomerId) > 0 )
         {
            A11CustomerId = (short)(context.localUtil.CToN( cgiGet( sCtrlA11CustomerId), ",", "."));
            AssignAttri(sPrefix, false, "A11CustomerId", StringUtil.LTrimStr( (decimal)(A11CustomerId), 4, 0));
         }
         else
         {
            A11CustomerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A11CustomerId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A11CustomerId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11CustomerId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA11CustomerId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A11CustomerId_CTRL", StringUtil.RTrim( sCtrlA11CustomerId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351923484191", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("customergeneral.js", "?202351923484191", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A11CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'A8CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E111E1',iparms:[{av:'A11CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E121E1',iparms:[{av:'A11CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001E2_A11CustomerId = new short[1] ;
         H001E2_A9CountryName = new string[] {""} ;
         H001E2_A8CountryId = new short[1] ;
         H001E2_A23CustomerPhone = new string[] {""} ;
         H001E2_A22CustomerEmail = new string[] {""} ;
         H001E2_A21CustomerAddress = new string[] {""} ;
         H001E2_A20CustomerName = new string[] {""} ;
         hsh = "";
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customergeneral__default(),
            new Object[][] {
                new Object[] {
               H001E2_A11CustomerId, H001E2_A9CountryName, H001E2_A8CountryId, H001E2_A23CustomerPhone, H001E2_A22CustomerEmail, H001E2_A21CustomerAddress, H001E2_A20CustomerName
               }
            }
         );
         AV13Pgmname = "CustomerGeneral";
      ...
      private short wcpOA11CustomerId ;
      ...
      private string hsh ;
      private string sCtrlA11CustomerId ;
      ...
      private short[] H001E2_A11CustomerId ;
      private string[] H001E2_A9CountryName ;
      private short[] H001E2_A8CountryId ;
      private string[] H001E2_A23CustomerPhone ;
      private string[] H001E2_A22CustomerEmail ;
      private string[] H001E2_A21CustomerAddress ;
      private string[] H001E2_A20CustomerName ;
   ...
   public class customergeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001E2", "SELECT T1.[CustomerId], T2.[CountryName], T1.[CountryId], T1.[CustomerPhone], T1.[CustomerEmail], T1.[CustomerAddress], T1.[CustomerName] FROM ([Customer] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) WHERE T1.[CustomerId] = @CustomerId ORDER BY T1.[CustomerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
