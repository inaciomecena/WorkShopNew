...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "ShoppingCart" , Namespace = "WorkShopNew" )]
   [Serializable]
   public class SdtShoppingCart : GxSilentTrnSdt
   {
      ...
      public void Load( short AV16ShoppingCartId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV16ShoppingCartId});
         return  ;
      }
      ...
      public GXBCLevelCollection<SdtShoppingCart_Product> gxTpr_Product_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtShoppingCart_Product == null )
            {
               gxTv_SdtShoppingCart_Product = new GXBCLevelCollection<SdtShoppingCart_Product>( context, "ShoppingCart.Product", "WorkShopNew");
            }
   ...
   [DataContract(Name = @"ShoppingCart", Namespace = "WorkShopNew")]
   public class SdtShoppingCart_RESTInterface : GxGenericCollectionItem<SdtShoppingCart>
   {
      ...
      [DataMember( Name = "ShoppingCartFinalPrice" , Order = 9 )]
      [GxSeudo()]
