...
namespace GeneXus.Programs {
   public class deletecarts : GXProcedure
   {
                                 ...
                                 ref DateTime aP1_ToDate )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objdeletecarts);
         aP0_FromDate=this.AV8FromDate;
         aP1_ToDate=this.AV9ToDate;
      }
      ...
      void executePrivate( )
      {
         ...
         {
            A33ShoppingCartDate = P000J2_A33ShoppingCartDate[0];
            A16ShoppingCartId = P000J2_A16ShoppingCartId[0];
            AV10ShoppingCart.Load(A16ShoppingCartId);
      ...
      public override void initialize( )
      {
         ...
         P000J2_A33ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         P000J2_A16ShoppingCartId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.deletecarts__default(),
            new Object[][] {
                new Object[] {
               P000J2_A33ShoppingCartDate, P000J2_A16ShoppingCartId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private DateTime[] P000J2_A33ShoppingCartDate ;
      private short[] P000J2_A16ShoppingCartId ;
