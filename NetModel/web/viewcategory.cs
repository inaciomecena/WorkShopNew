...
namespace GeneXus.Programs {
   public class viewcategory : GXDataArea
   {
      public viewcategory( )
      {
      ...
      public viewcategory( IGxContext context )
      {
      ...
      public void execute( short aP0_CategoryId ,
                           string aP1_TabCode )
      {
         this.AV12CategoryId = aP0_CategoryId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12CategoryId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12CategoryId", StringUtil.LTrimStr( (decimal)(AV12CategoryId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CategoryId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235218301139", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcategory.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12CategoryId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"CategoryId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("CategoryName", StringUtil.RTrim( context.localUtil.Format( A7CategoryName, "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCATEGORYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CategoryId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CategoryId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewcategory.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12CategoryId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"CategoryId","TabCode"})  ;
      }
      ...
      protected void WB180( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Category Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewCategory.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Categories", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCategory.htm");
            ...
            GxWebStd.gx_label_element( context, edtCategoryName_Internalname, "da Categoria", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, StringUtil.RTrim( A7CategoryName), StringUtil.RTrim( context.localUtil.Format( A7CategoryName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewCategory.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCategory.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Produtos", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCategory.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START182( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Category", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF182( )
      {
         ...
         {
            /* Using cursor H00182 */
            pr_default.execute(0, new Object[] {AV12CategoryId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A6CategoryId = H00182_A6CategoryId[0];
               A7CategoryName = H00182_A7CategoryName[0];
      ...
      protected void STRUP180( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12CategoryId = (short)(context.localUtil.CToN( cgiGet( "vCATEGORYID"), ",", "."));
      ...
      protected void E11182( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00183 */
         pr_default.execute(1, new Object[] {AV12CategoryId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A6CategoryId = H00183_A6CategoryId[0];
            A7CategoryName = H00183_A7CategoryName[0];
            AssignAttri("", false, "A7CategoryName", A7CategoryName);
            AV16GXLvl6 = 1;
            Form.Caption = A7CategoryName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwcategory.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "CategoryGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "categorygeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "CategoryGeneral";
               WebComp_Generalwc_Component = "CategoryGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12CategoryId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "CategoryProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "categoryproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "CategoryProductWC";
               WebComp_Productwc_Component = "CategoryProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12CategoryId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12CategoryId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12CategoryId", StringUtil.LTrimStr( (decimal)(AV12CategoryId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CategoryId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235218301194", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcategory.js", "?20235218301194", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12CategoryId',fld:'vCATEGORYID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A7CategoryName',fld:'CATEGORYNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00182_A6CategoryId = new short[1] ;
         H00182_A7CategoryName = new string[] {""} ;
         hsh = "";
         H00183_A6CategoryId = new short[1] ;
         H00183_A7CategoryName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcategory__default(),
            new Object[][] {
                new Object[] {
               H00182_A6CategoryId, H00182_A7CategoryName
               }
               , new Object[] {
               H00183_A6CategoryId, H00183_A7CategoryName
               }
            }
         );
      ...
      private short[] H00182_A6CategoryId ;
      private string[] H00182_A7CategoryName ;
      private short[] H00183_A6CategoryId ;
      private string[] H00183_A7CategoryName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewcategory__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12CategoryId",GXType.Int16,4,0)
          };
          Object[] prmH00183;
          ...
          def= new CursorDef[] {
              new CursorDef("H00182", "SELECT [CategoryId], [CategoryName] FROM [Category] WHERE [CategoryId] = @AV12CategoryId ORDER BY [CategoryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00182,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00183", "SELECT [CategoryId], [CategoryName] FROM [Category] WHERE [CategoryId] = @AV12CategoryId ORDER BY [CategoryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00183,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
