...
namespace GeneXus.Programs {
   public class wwseller : GXDataArea
   {
      public wwseller( )
      {
      ...
      public wwseller( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV11SellerName = GetPar( "SellerName");
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11SellerName) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351923484851", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwseller.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSELLERNAME", StringUtil.RTrim( AV11SellerName));
         /* Send saved values. */
      ...
      {
         return formatLink("wwseller.aspx")  ;
      }
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Sellers", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWSeller.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSeller.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavSellername_Internalname, "Seller Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSellername_Internalname, StringUtil.RTrim( AV11SellerName), StringUtil.RTrim( context.localUtil.Format( AV11SellerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavSellername_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavSellername_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWSeller.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0E2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Sellers", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), !bGXsfl_25_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Sellername Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vSELLERNAME"), AV11SellerName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0E2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavSellername_Internalname;
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11SellerName = StringUtil.PadR( StringUtil.RTrim( AV11SellerName), 20, "%");
            /* Using cursor H000E2 */
            pr_default.execute(0, new Object[] {lV11SellerName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A9CountryName = H000E2_A9CountryName[0];
               A8CountryId = H000E2_A8CountryId[0];
               A40000SellerPhoto_GXI = H000E2_A40000SellerPhoto_GXI[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A19SellerPhoto), true);
               A18SellerName = H000E2_A18SellerName[0];
               A10SellerId = H000E2_A10SellerId[0];
               A19SellerPhoto = H000E2_A19SellerPhoto[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A19SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A19SellerPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A19SellerPhoto), true);
               A9CountryName = H000E2_A9CountryName[0];
               E140E2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SELLERID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A10SellerId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11SellerName = StringUtil.PadR( StringUtil.RTrim( AV11SellerName), 20, "%");
         /* Using cursor H000E3 */
         pr_default.execute(1, new Object[] {lV11SellerName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11SellerName = GridState.FilterValues("Sellername");
            AssignAttri("", false, "AV11SellerName", AV11SellerName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("SellerName", AV11SellerName);
      }
      ...
      protected void STRUP0E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11SellerName = cgiGet( edtavSellername_Internalname);
            AssignAttri("", false, "AV11SellerName", AV11SellerName);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Seller";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351923484894", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwseller.js", "?202351923484894", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtavSellername_Internalname = "vSELLERNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavSellername_Jsonclick = "";
         edtavSellername_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SellerName',fld:'vSELLERNAME',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140E2',iparms:[{av:'A10SellerId',fld:'SELLERID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtSellerName_Link',ctrl:'SELLERNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110E2',iparms:[{av:'A10SellerId',fld:'SELLERID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SellerName',fld:'vSELLERNAME',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SellerName',fld:'vSELLERNAME',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SellerName',fld:'vSELLERNAME',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SellerName',fld:'vSELLERNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11SellerName = "";
         H000E2_A9CountryName = new string[] {""} ;
         H000E2_A8CountryId = new short[1] ;
         H000E2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000E2_A18SellerName = new string[] {""} ;
         H000E2_A10SellerId = new short[1] ;
         H000E2_A19SellerPhoto = new string[] {""} ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwseller__default(),
            new Object[][] {
                new Object[] {
               H000E2_A9CountryName, H000E2_A8CountryId, H000E2_A40000SellerPhoto_GXI, H000E2_A18SellerName, H000E2_A10SellerId, H000E2_A19SellerPhoto
               }
               , new Object[] {
      ...
      private int edtavSellername_Enabled ;
      ...
      private string edtavSellername_Internalname ;
      private string edtavSellername_Jsonclick ;
      ...
      private string[] H000E2_A9CountryName ;
      private short[] H000E2_A8CountryId ;
      private string[] H000E2_A40000SellerPhoto_GXI ;
      private string[] H000E2_A18SellerName ;
      private short[] H000E2_A10SellerId ;
      private string[] H000E2_A19SellerPhoto ;
   ...
   public class wwseller__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A18SellerName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[CountryName], T1.[CountryId], T1.[SellerPhoto_GXI], T1.[SellerName], T1.[SellerId], T1.[SellerPhoto]";
         sFromString = " FROM ([Seller] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11SellerName)) )
         {
            AddWhere(sWhereString, "(T1.[SellerName] like @lV11SellerName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[SellerName]";
                                             ...
                                             string A18SellerName )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Seller] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11SellerName)) )
         {
            AddWhere(sWhereString, "(T1.[SellerName] like @lV11SellerName)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11SellerName",GXType.NChar,20,0) ,
