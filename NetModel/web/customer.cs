...
namespace GeneXus.Programs {
   public class customer : GXDataArea
   {
      ...
      protected void CheckExtendedTable075( )
      {
         ...
         {
            GX_msglist.addItem("Campo endereço deve ser preenchido!", 1, "CUSTOMERADDRESS");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("O valor de E-mail não coincide com o padrão especificado", "OutOfRange", 1, "CUSTOMEREMAIL");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20235201493532", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20235201493548", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customer.js", "?20235201493548", false, true);
