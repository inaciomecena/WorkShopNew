...
namespace GeneXus.Programs {
   public class customer : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCountryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A8CountryId), 4, 0, ",", "")), StringUtil.LTrim( ((edtCountryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A8CountryId), "ZZZ9") : context.localUtil.Format( (decimal)(A8CountryId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_Customer.htm");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_enter_Internalname, "", "Confirmar", bttBtn_enter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      protected void CheckExtendedTable075( )
      {
         ...
         {
            GX_msglist.addItem("Their name cannot be empty", 1, "CUSTOMERNAME");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Their address cannot be empty", 1, "CUSTOMERADDRESS");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("O valor de Customer Email não coincide com o padrão especificado", "OutOfRange", 1, "CUSTOMEREMAIL");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Their phone is empty!", 0, "CUSTOMERPHONE");
         }
         /* Using cursor T00074 */
      ...
      protected void gxLoad_6( short A8CountryId )
      {
         /* Using cursor T00076 */
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351822453353", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351822453362", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customer.js", "?202351822453363", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_CUSTOMERID","{handler:'Valid_Customerid',iparms:[{av:'A11CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         setEventMetadata("VALID_CUSTOMERID",",oparms:[{av:'A20CustomerName',fld:'CUSTOMERNAME',pic:''},{av:'A21CustomerAddress',fld:'CUSTOMERADDRESS',pic:''},{av:'A22CustomerEmail',fld:'CUSTOMEREMAIL',pic:''},{av:'A23CustomerPhone',fld:'CUSTOMERPHONE',pic:''},{av:'A8CountryId',fld:'COUNTRYID',pic:'ZZZ9'},{av:'A9CountryName',fld:'COUNTRYNAME',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'Z11CustomerId'},{av:'Z20CustomerName'},{av:'Z21CustomerAddress'},{av:'Z22CustomerEmail'},{av:'Z23CustomerPhone'},{av:'Z8CountryId'},{av:'Z9CountryName'},{ctrl:'BTN_DELETE',prop:'Enabled'},{ctrl:'BTN_ENTER',prop:'Enabled'}]}");
      ...
      private string ZZ20CustomerName ;
      private string ZZ23CustomerPhone ;
      ...
      private string ZZ21CustomerAddress ;
      private string ZZ22CustomerEmail ;
