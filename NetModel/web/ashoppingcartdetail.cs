   ...
   public class ashoppingcartdetail : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            H0F0( false, 184) ;
            getPrinter().GxDrawBitMap(context.GetImagePath( "50c64e13-af36-43d1-b4fd-317015ca69d8", "", context.GetTheme( )), 117, Gx_line+17, 246, Gx_line+146) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 40, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText("My Shopping Cart", 292, Gx_line+50, 750, Gx_line+116, 0, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               while ( (pr_default.getStatus(1) != 101) )
               {
                  ...
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( A27ProductPrice, "$ ZZZZ9.99")), 275, Gx_line+33, 370, Gx_line+55, 2+256, 0, 0, 0) ;
                  ...
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( A35TotalProduct, "$ ZZZZ9.99")), 633, Gx_line+33, 728, Gx_line+55, 2+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
