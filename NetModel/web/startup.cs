...
namespace GeneXus.Programs {
   public class startup : GXDataArea
   {
      public startup( )
      {
      ...
      public startup( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("startup.aspx") +"\">") ;
      ...
      {
         return formatLink("startup.aspx")  ;
      }
      ...
      protected void START0K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Start Up", 0) ;
         }
         context.wjLoc = "";
