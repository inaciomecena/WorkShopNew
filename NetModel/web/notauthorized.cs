...
namespace GeneXus.Programs {
   public class notauthorized : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351822112190", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"\" data-gx-class=\"\" novalidate action=\""+formatLink("notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(GxObject))}, new string[] {"GxObject"}) +"\">") ;
         GxWebStd.gx_hidden_field( context, "_EventName", "");
         GxWebStd.gx_hidden_field( context, "_EventGridId", "");
         GxWebStd.gx_hidden_field( context, "_EventRowId", "");
         context.WriteHtmlText( "<input type=\"submit\" title=\"submit\" style=\"display:block;height:0;border:0;padding:0\" disabled>") ;
         AssignProp("", false, "FORM", "Class", "", true);
         toggleJsOutput = isJsOutputEnabled( );
         if ( context.isSpaRequest( ) )
         {
            disableJsOutput();
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_4_092( true) ;
         }
         else
         {
            wb_table1_4_092( false) ;
         }
         return  ;
      }

      protected void wb_table1_4_092e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_13_092( true) ;
         }
         else
         {
            wb_table2_13_092( false) ;
         }
         return  ;
      }

      protected void wb_table2_13_092e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_16_092( true) ;
         }
         else
         {
            wb_table3_16_092( false) ;
         }
         return  ;
      }

      protected void wb_table3_16_092e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_16_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_16_092e( true) ;
         }
         else
         {
            wb_table3_16_092e( false) ;
         }
      }

      protected void wb_table2_13_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_13_092e( true) ;
         }
         else
         {
            wb_table2_13_092e( false) ;
         }
      }

      protected void wb_table1_4_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Not Authorized", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 0, 0, "HLP_NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td colspan=\"2\" >") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_4_092e( true) ;
         }
         else
         {
            wb_table1_4_092e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351822112218", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("notauthorized.js", "?202351822112218", false, true);
